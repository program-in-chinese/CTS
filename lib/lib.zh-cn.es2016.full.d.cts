...
/// <引用 不用默认库="真"/>
/// <引用 路径="lib.zh-cn.es2015.d.cts" />
/// <引用 路径="lib.zh-cn.es2016.array.include.d.cts" />
/////////////////////////////
/// DOM APIs
/////////////////////////////
//@@{ 账户_:Account }
...
接口 分析器节点_ 扩展 音频节点_ {
    ...
    平滑时间常数: 数字;
    //@@{ 取字节频率数据:getByteFrequencyData, 正整数数组8_:Uint8Array }
    取字节频率数据(数组: 正整数数组8_): 无值;
    //@@{ 取字节时间域数据:getByteTimeDomainData, 正整数数组8_:Uint8Array }
    取字节时间域数据(数组: 正整数数组8_): 无值;
    //@@{ 取浮动频率数据:getFloatFrequencyData, 浮点数组32_:Float32Array }
    取浮动频率数据(数组: 浮点数组32_): 无值;
    //@@{ 取浮点时域数据:getFloatTimeDomainData, 浮点数组32_:Float32Array }
...
接口 角_实例化_数组_ {
    //@@{ 画数组实例化角:drawArraysInstancedANGLE }
    画数组实例化角(模式: 数字, 第一个: 数字, 数量: 数字, 主要数量: 数字): 无值;
    //@@{ 画元素实例化角:drawElementsInstancedANGLE }
    画元素实例化角(模式: 数字, 数量: 数字, 类型: 数字, 偏移: 数字, 主要数量: 数字): 无值;
    //@@{ 顶点属性因子角度:vertexAttribDivisorANGLE }
...
声明 值量 动画事件_: {
    ...
    原型: 动画事件_;
    //@@{ 动画事件初始化_:AnimationEventInit, 动画事件_:AnimationEvent }
...
接口 应用程序缓存_ 扩展 事件目标_ {
    ...
    //@@{ 准备更新:UPDATEREADY }
    只读 准备更新: 数字;
    //@@{ 添加事件监听器:addEventListener, 应用程序缓存事件映射_:ApplicationCacheEventMap, 应用程序缓存_:ApplicationCache }
...
接口 音频缓冲区_ {
    ...
    //@@{ 采样率:sampleRate }
    只读 采样率: 数字;
    //@@{ 复制从通道:copyFromChannel, 浮点数组32_:Float32Array }
    复制从通道(目的地: 浮点数组32_, 通道号: 数字, 开始通道?: 数字): 无值;
    //@@{ 复制到通道:copyToChannel, 浮点数组32_:Float32Array }
    复制到通道(源: 浮点数组32_, 通道号: 数字, 开始通道?: 数字): 无值;
    //@@{ 取通道数据:getChannelData, 浮点数组32_:Float32Array }
    取通道数据(通道: 数字): 浮点数组32_;
...
接口 音频缓冲源节点事件映射_ {
    //@@{ 媒体流错误事件_:MediaStreamErrorEvent }
    "结束了": 媒体流错误事件_;
...
接口 音频缓冲区源节点_ 扩展 音频节点_ {
    ...
    //@@{ 停止:stop }
    停止(当?: 数字): 无值;
    //@@{ 添加事件监听器:addEventListener, 音频缓冲源节点事件映射_:AudioBufferSourceNodeEventMap, 音频缓冲区源节点_:AudioBufferSourceNode }
...
接口 音频上下文基类_ 扩展 事件目标_ {
    ...
    创建滤波器(): 双二次滤波器节点_;
    //@@{ 创建缓冲区:createBuffer, 音频缓冲区_:AudioBuffer }
    创建缓冲区(通道数量: 数字, 长度: 数字, 采样率: 数字): 音频缓冲区_;
    //@@{ 创建缓冲区源:createBufferSource, 音频缓冲区源节点_:AudioBufferSourceNode }
    创建缓冲区源(): 音频缓冲区源节点_;
    //@@{ 创建通道合并:createChannelMerger, 通道合并节点_:ChannelMergerNode }
    创建通道合并(输入数量?: 数字): 通道合并节点_;
    //@@{ 创建通道分流器:createChannelSplitter, 通道分流节点_:ChannelSplitterNode }
    创建通道分流器(输出数量?: 数字): 通道分流节点_;
    //@@{ 创建卷积器:createConvolver, 卷积器节点_:ConvolverNode }
    创建卷积器(): 卷积器节点_;
    //@@{ 创建延迟:createDelay, 延迟节点_:DelayNode }
    创建延迟(最大延迟时间?: 数字): 延迟节点_;
    //@@{ 创建动态压缩器:createDynamicsCompressor, 动态压缩节点_:DynamicsCompressorNode }
    创建动态压缩器(): 动态压缩节点_;
    //@@{ 创建增益:createGain, 增加节点_:GainNode }
    创建增益(): 增加节点_;
    //@@{ 创建IIR滤波器:createIIRFilter, IIR滤波器节点_:IIRFilterNode }
    创建IIR滤波器(前馈: 数字[], 反馈: 数字[]): IIR滤波器节点_;
    //@@{ 创建媒体元素源:createMediaElementSource, HTML媒体元素_:HTMLMediaElement, 媒体元素音频源节点_:MediaElementAudioSourceNode }
    创建媒体元素源(媒体元素: HTML媒体元素_): 媒体元素音频源节点_;
    //@@{ 创建媒体流源:createMediaStreamSource, 媒体流_:MediaStream }
    ...
    创建音源环境(): 音源环境节点_;
    //@@{ 创建周期波:createPeriodicWave, 浮点数组32_:Float32Array, 周期波约束_:PeriodicWaveConstraints, 周期波_:PeriodicWave }
    创建周期波(真正的: 浮点数组32_, 想象的: 浮点数组32_, 约束?: 周期波约束_): 周期波_;
    //@@{ 创建脚本处理器:createScriptProcessor, 脚本处理器节点_:ScriptProcessorNode }
    ...
    创建波型控制器(): 波形控制器节点_;
    //@@{ 解码音频数据:decodeAudioData, 数组缓冲区_:ArrayBuffer, 解码成功回调_:DecodeSuccessCallback, 解码错误回调_:DecodeErrorCallback, 预设_:Promise, 音频缓冲区_:AudioBuffer }
    解码音频数据(音频数据: 数组缓冲区_, 成功回调?: 解码成功回调_, 错误回调?: 解码错误回调_): 预设_<音频缓冲区_>;
    //@@{ 继续:resume, 预设_:Promise }
    继续(): 预设_<无值>;
    //@@{ 添加事件监听器:addEventListener, 音频上下文事件映射_:AudioContextEventMap, 音频上下文_:AudioContext }
...
接口 音频节点_ 扩展 事件目标_ {
    ...
    只读 输出数量: 数字;
    //@@{ 连接:connect, 音频节点_:AudioNode }
    连接(目的地: 音频节点_, 输出?: 数字, 输入?: 数字): 音频节点_;
    //@@{ 连接:connect, 音频参数_:AudioParam }
    连接(目的地: 音频参数_, 输出?: 数字): 无值;
    //@@{ 断开连接:disconnect }
    断开连接(输出?: 数字): 无值;
    //@@{ 断开连接:disconnect, 音频节点_:AudioNode }
    断开连接(目的地: 音频节点_, 输出?: 数字, 输入?: 数字): 无值;
    //@@{ 断开连接:disconnect, 音频参数_:AudioParam }
...
接口 音频参数_ {
    ...
    //@@{ 值:value }
    值: 数字;
    //@@{ 取消预定值:cancelScheduledValues, 音频参数_:AudioParam }
    取消预定值(开始时间: 数字): 音频参数_;
    //@@{ 指数上升时间值:exponentialRampToValueAtTime, 音频参数_:AudioParam }
    指数上升时间值(值: 数字, 结束时间: 数字): 音频参数_;
    //@@{ 线性上升时间值:linearRampToValueAtTime, 音频参数_:AudioParam }
    线性上升时间值(值: 数字, 结束时间: 数字): 音频参数_;
    //@@{ 置目标时间:setTargetAtTime, 音频参数_:AudioParam }
    置目标时间(目标: 数字, 开始时间: 数字, 时间常数: 数字): 音频参数_;
    //@@{ 置值时间:setValueAtTime, 音频参数_:AudioParam }
    置值时间(值: 数字, 开始时间: 数字): 音频参数_;
    //@@{ 置值时间曲线:setValueCurveAtTime, 浮点数组32_:Float32Array, 音频参数_:AudioParam }
...
接口 音频轨道列表_ 扩展 事件目标_ {
    ...
    //@@{ 项目:item, 音频轨道_:AudioTrack }
    项目(索引: 数字): 音频轨道_;
    //@@{ 添加事件监听器:addEventListener, 音频轨道列表事件映射_:AudioTrackListEventMap, 音频轨道列表_:AudioTrackList }
...
接口 双二次滤波器节点_ 扩展 音频节点_ {
    ...
    类型: 滤波器类型_;
    //@@{ 取频率响应:getFrequencyResponse, 浮点数组32_:Float32Array }
...
声明 值量 二进制对象_: {
    ...
    原型: 二进制对象_;
    //@@{ 二进制对象属性包_:BlobPropertyBag, 二进制对象_:Blob }
    新建 (二进制对象部分?: 任意[], 选项?: 二进制对象属性包_): 二进制对象_;

};
//@@{ 缓存_:Cache }
接口 缓存_ {
    //@@{ 添加:add, 请求信息_:RequestInfo, 预设_:Promise }
    添加(请求: 请求信息_): 预设_<无值>;
    //@@{ 添加所有:addAll, 请求信息_:RequestInfo, 预设_:Promise }
    添加所有(请求组: 请求信息_[]): 预设_<无值>;
    //@@{ 删除:delete, 请求信息_:RequestInfo, 缓存查询选项_:CacheQueryOptions, 预设_:Promise }
    删除(请求: 请求信息_, 选项?: 缓存查询选项_): 预设_<真假>;
    //@@{ 键组:keys, 请求信息_:RequestInfo, 缓存查询选项_:CacheQueryOptions, 预设_:Promise, 请求_:Request }
    键组(请求?: 请求信息_, 选项?: 缓存查询选项_): 预设_<请求_[]>;
    //@@{ 匹配:match, 请求信息_:RequestInfo, 缓存查询选项_:CacheQueryOptions, 预设_:Promise, 响应_:Response }
    匹配(请求: 请求信息_, 选项?: 缓存查询选项_): 预设_<响应_>;
    //@@{ 匹配所有:matchAll, 请求信息_:RequestInfo, 缓存查询选项_:CacheQueryOptions, 预设_:Promise, 响应_:Response }
    匹配所有(请求?: 请求信息_, 选项?: 缓存查询选项_): 预设_<响应_[]>;
    //@@{ 放入:put, 请求信息_:RequestInfo, 响应_:Response, 预设_:Promise }
...
//@@{ 缓存存储_:CacheStorage }
接口 缓存存储_ {
    //@@{ 删除:delete, 预设_:Promise }
    删除(缓存名称: 文字): 预设_<真假>;
    //@@{ 存在:has, 预设_:Promise }
    存在(缓存名称: 文字): 预设_<真假>;
    //@@{ 键组:keys, 预设_:Promise }
    键组(): 预设_<文字[]>;
    //@@{ 匹配:match, 请求信息_:RequestInfo, 缓存查询选项_:CacheQueryOptions, 预设_:Promise }
    匹配(请求: 请求信息_, 选项?: 缓存查询选项_): 预设_<任意>;
    //@@{ 打开:open, 预设_:Promise, 缓存_:Cache }
    打开(缓存名称: 文字): 预设_<缓存_>;
...
//@@{ 画板模式_:CanvasPattern }
接口 画板模式_ {
    //@@{ 置转换:setTransform, SVG矩阵_:SVGMatrix }
    置转换(矩阵: SVG矩阵_): 无值;
...
接口 画板渲染上下文2D_ 扩展 实例_, 画板路径方法_ {
    ...
    //@@{ 剪切:clip, 画板填满规则_:CanvasFillRule }
    剪切(填充规则?: 画板填满规则_): 无值;
    //@@{ 创建图像数据:createImageData, 图像数据_:ImageData }
    创建图像数据(图像数据或Sw: 数字 | 图像数据_, sh?: 数字): 图像数据_;
    //@@{ 创建线性渐变:createLinearGradient, 画板梯度_:CanvasGradient }
    创建线性渐变(x0: 数字, y0: 数字, x1: 数字, y1: 数字): 画板梯度_;
    //@@{ 创建模式:createPattern, HTML图像元素_:HTMLImageElement, HTML画板元素_:HTMLCanvasElement, HTML视频元素_:HTMLVideoElement, 画板模式_:CanvasPattern }
    ...
    //@@{ 画重点如果需要:drawFocusIfNeeded, 元素_:Element }
    画重点如果需要(元素: 元素_): 无值;
    //@@{ 画图像:drawImage, HTML图像元素_:HTMLImageElement, HTML画板元素_:HTMLCanvasElement, HTML视频元素_:HTMLVideoElement, 位图图像_:ImageBitmap }
    ...
    //@@{ 填充:fill, 画板填满规则_:CanvasFillRule }
    填充(填充规则?: 画板填满规则_): 无值;
    //@@{ 填充矩形:fillRect }
    ...
    //@@{ 取虚线:getLineDash }
    取虚线(): 数字[];
    //@@{ 是路径内点:isPointInPath, 画板填满规则_:CanvasFillRule }
    是路径内点(x: 数字, y: 数字, 填充规则?: 画板填满规则_): 真假;
    //@@{ 测量文本:measureText, 文本指标_:TextMetrics }
    测量文本(文本: 文字): 文本指标_;
    //@@{ 放入图像数据:putImageData, 图像数据_:ImageData }
...
声明 值量 剪贴板事件_: {
    ...
    原型: 剪贴板事件_;
    //@@{ 剪贴板事件初始化_:ClipboardEventInit, 剪贴板事件_:ClipboardEvent }
...
声明 值量 关闭事件_: {
    ...
    原型: 关闭事件_;
    //@@{ 关闭事件初始化_:CloseEventInit, 关闭事件_:CloseEvent }
...
接口 组件事件_ 扩展 UI事件_ {
    ...
    //@@{ 语言环境:locale }
    只读 语言环境: 文字;
    //@@{ 初始化组件事件:initCompositionEvent, 窗口_:Window }
...
声明 值量 组件事件_: {
    ...
    原型: 组件事件_;
    //@@{ 组件事件初始化_:CompositionEventInit, 组件事件_:CompositionEvent }
...
接口 控制台_ {
    ...
    //@@{ 日志:log }
    日志(消息?: 任意, ...可选参数: 任意[]): 无值;
    //@@{ ms是独立组件:msIsIndependentlyComposed, 元素_:Element }
    ms是独立组件(元素: 元素_): 真假;
    //@@{ 配置文件:profile }
    配置文件(报告名称?: 文字): 无值;
    //@@{ 配置文件结束:profileEnd }
    配置文件结束(): 无值;
    //@@{ 选择:select, 元素_:Element }
    选择(元素: 元素_): 无值;
    //@@{ 表:table }
    表(...数据: 任意[]): 无值;
    //@@{ 时间:time }
...
接口 CSS关键帧组规则_ 扩展 CSS规则_ {
    ...
    //@@{ 删除规则:deleteRule }
    删除规则(规则: 文字): 无值;
    //@@{ 查找规则:findRule, CSS关键帧规则_:CSSKeyframeRule }
...
声明 值量 自定义事件_: {
    ...
    原型: 自定义事件_;
    //@@{ 自定义事件初始化_:CustomEventInit, 自定义事件_:CustomEvent }
...
接口 数据提示_ 扩展 文本轨道提示_ {
    ...
    数据: 数组缓冲区_;
    //@@{ 添加事件监听器:addEventListener, 文本轨道提示事件映射_:TextTrackCueEventMap, 数据提示_:DataCue }
...
接口 数据传输_ {
    ...
    //@@{ 置数据:setData }
    置数据(格式: 文字, 数据: 文字): 真假;
    //@@{ 置拖拽图像:setDragImage, 元素_:Element }
...
接口 数据传输项目_ {
    ...
    取转为文件(): 文件_ | 空值;
    //@@{ 取转为文字:getAsString, 函数字符串回调_:FunctionStringCallback }
...
接口 数据传输项目列表_ {
    //@@{ 长度:length }
    只读 长度: 数字;
    //@@{ 添加:add, 文件_:File, 数据传输项目_:DataTransferItem }
    添加(数据: 文件_): 数据传输项目_ | 空值;
    //@@{ 清除:clear }
    清除(): 无值;
    //@@{ 项目:item, 数据传输项目_:DataTransferItem }
    项目(索引: 数字): 数据传输项目_;
    //@@{ 删除:remove }
    删除(索引: 数字): 无值;
    //@@{ 数据传输项目_:DataTransferItem }
...
//@@{ 设备环境光事件_:DeviceLightEvent }
声明 值量 设备环境光事件_: {
    //@@{ 原型:prototype, 设备环境光事件_:DeviceLightEvent }
    原型: 设备环境光事件_;
    //@@{ 设备环境光事件初始化_:DeviceLightEventInit, 设备环境光事件_:DeviceLightEvent }
...
接口 设备运动事件_ 扩展 事件_ {
    ...
    只读 旋转速度: 设备旋转速度_ | 空值;
    //@@{ 初始化设备运动事件:initDeviceMotionEvent, 设备加速度词典_:DeviceAccelerationDict, 设备旋转速度词典_:DeviceRotationRateDict }
    初始化设备运动事件(类型: 文字, 冒泡: 真假, 可取消的: 真假, 加速度: 设备加速度词典_ | 空值, 包括重力加速度: 设备加速度词典_ | 空值, 旋转速度: 设备旋转速度词典_ | 空值, 时间间隔: 数字 | 空值): 无值;

}
//@@{ 设备运动事件_:DeviceMotionEvent }
声明 值量 设备运动事件_: {
    //@@{ 原型:prototype, 设备运动事件_:DeviceMotionEvent }
    原型: 设备运动事件_;
    //@@{ 设备运动事件初始化_:DeviceMotionEventInit, 设备运动事件_:DeviceMotionEvent }
...
接口 设备定位事件_ 扩展 事件_ {
    ...
    //@@{ 绕y轴方向:gamma }
    只读 绕y轴方向: 数字 | 空值;
    //@@{ 初始化设备朝向事件:initDeviceOrientationEvent }
    初始化设备朝向事件(类型: 文字, 冒泡: 真假, 可取消的: 真假, 指示方向: 数字 | 空值, 绕x轴方向: 数字 | 空值, 绕y轴方向: 数字 | 空值, 绝对: 真假): 无值;

}
//@@{ 设备定位事件_:DeviceOrientationEvent }
声明 值量 设备定位事件_: {
    //@@{ 原型:prototype, 设备定位事件_:DeviceOrientationEvent }
    原型: 设备定位事件_;
    //@@{ 设备朝向事件初始化_:DeviceOrientationEventInit, 设备定位事件_:DeviceOrientationEvent }
...
接口 文档_ 扩展 节点_, 全局事件处理程序_, 节点选择器_, 文档事件_, 父节点_, 文档或影子根_ {
     ...
     */
    //@@{ 创建特性:createAttribute, 特性_:Attr }
    创建特性(名字: 文字): 特性_;
    //@@{ 创建特性NS:createAttributeNS, 特性_:Attr }
    创建特性NS(名称空间URI: 文字 | 空值, 限定名: 文字): 特性_;
    //@@{ 创建CDATA区段:createCDATASection, CDATA区段_:CDATASection }
     ...
     */
    //@@{ 创建注释:createComment, 注释_:Comment }
    创建注释(数据: 文字): 注释_;
     ...
     */
    //@@{ 创建节点迭代器:createNodeIterator, 节点_:Node, 节点过滤器_:NodeFilter, 节点迭代器_:NodeIterator }
    创建节点迭代器(根: 节点_, 如何显示?: 数字, 过滤器?: 节点过滤器_, 实体引用展开?: 真假): 节点迭代器_;
    //@@{ 创建NS解析器:createNSResolver, 节点_:Node, X路径NS解析器_:XPathNSResolver }
    创建NS解析器(节点解析器: 节点_): X路径NS解析器_;
    //@@{ 创建处理指令:createProcessingInstruction, 处理指令_:ProcessingInstruction }
     ...
     */
    //@@{ 创建文本节点:createTextNode, 文本_:Text }
    创建文本节点(数据: 文字): 文本_;
    //@@{ 创建触摸:createTouch, 窗口_:Window, 事件目标_:EventTarget, 触摸_:Touch }
    创建触摸(视图: 窗口_, 目标: 事件目标_, 标识符: 数字, 页面X: 数字, 页面Y: 数字, 屏幕X: 数字, 屏幕Y: 数字): 触摸_;
    //@@{ 创建触摸列表:createTouchList, 触摸_:Touch, 触摸列表_:TouchList }
     ...
     */
    //@@{ 创建树遍历方法:createTreeWalker, 节点_:Node, 节点过滤器_:NodeFilter, 树遍历方法_:TreeWalker }
    ...
    元素从点(x: 数字, y: 数字): 元素_;
    //@@{ 评估:evaluate, 节点_:Node, X路径NS解析器_:XPathNSResolver, X路径结果_:XPathResult }
     ...
     */
    //@@{ 取元素按Id:getElementById, HTML元素_:HTMLElement }
    取元素按Id(元素Id: 文字): HTML元素_ | 空值;
    //@@{ 取元素按类名称:getElementsByClassName, HTML集合的_:HTMLCollectionOf, 元素_:Element }
     ...
     */
    //@@{ 取元素按名称:getElementsByName, 节点列表的_:NodeListOf, HTML元素_:HTMLElement }
     ...
     */
    //@@{ 取元素按标签名称:getElementsByTagName, 元素列表标签名称映射_:ElementListTagNameMap }
    取元素按标签名称<K 扩展 键为 元素列表标签名称映射_>(标签名称: K): 元素列表标签名称映射_[K];
    //@@{ 取元素按标签名称:getElementsByTagName, 节点列表的_:NodeListOf, 元素_:Element }
    取元素按标签名称(标签名称: 文字): 节点列表的_<元素_>;
    //@@{ 取元素按标签名称NS:getElementsByTagNameNS, HTML集合的_:HTMLCollectionOf, HTML元素_:HTMLElement }
    取元素按标签名称NS(名称空间URI: "http://www.w3.org/1999/xhtml", 本地名称: 文字): HTML集合的_<HTML元素_>;
    //@@{ 取元素按标签名称NS:getElementsByTagNameNS, HTML集合的_:HTMLCollectionOf, SVG元素_:SVGElement }
    取元素按标签名称NS(名称空间URI: "http://www.w3.org/2000/svg", 本地名称: 文字): HTML集合的_<SVG元素_>;
    //@@{ 取元素按标签名称NS:getElementsByTagNameNS, HTML集合的_:HTMLCollectionOf, 元素_:Element }
     ...
     */
    //@@{ 查询命令不确定状态:queryCommandIndeterm }
    ...
    //@@{ 写含换行:writeln }
    写含换行(...内容: 文字[]): 无值;
    //@@{ 添加事件监听器:addEventListener, 文档事件映射_:DocumentEventMap, 文档_:Document }
...
接口 文档实现_ {
    //@@{ 创建文档:createDocument, 文档类型_:DocumentType, 文档_:Document }
    创建文档(名称空间URI: 文字 | 空值, 限定名: 文字 | 空值, 文档类型: 文档类型_ | 空值): 文档_;
    //@@{ 创建文档类型:createDocumentType, 文档类型_:DocumentType }
    创建文档类型(限定名: 文字, 公共Id: 文字, 系统Id: 文字): 文档类型_;
    //@@{ 创建HTML文档:createHTMLDocument, 文档_:Document }
    创建HTML文档(标题: 文字): 文档_;
    //@@{ 有某功能:hasFeature }
...
//@@{ 文档解析器_:DOMParser }
接口 文档解析器_ {
    //@@{ 解析从字符串:parseFromString, 文档_:Document }
...
接口 拖拽事件_ 扩展 鼠标事件_ {
    ...
    只读 数据传输: 数据传输_;
    //@@{ 初始化拖拽事件:initDragEvent, 窗口_:Window, 事件目标_:EventTarget, 数据传输_:DataTransfer }
...
声明 值量 拖拽事件_: {
    ...
    原型: 拖拽事件_;
    //@@{ 数据传输:dataTransfer, 数据传输_:DataTransfer, 拖拽事件_:DragEvent }
...
接口 元素_ 扩展 节点_, 全局事件处理程序_, 元素遍历_, 节点选择器_, 子节点_, 父节点_ {
    ...
    //@@{ 取特性:getAttribute }
    取特性(名字: 文字): 文字 | 空值;
    //@@{ 取特性节点:getAttributeNode, 特性_:Attr }
    取特性节点(名字: 文字): 特性_;
    //@@{ 取特性节点NS:getAttributeNodeNS, 特性_:Attr }
    ...
    //@@{ 置特性:setAttribute }
    置特性(名字: 文字, 值: 文字): 无值;
    //@@{ 置特性节点:setAttributeNode, 特性_:Attr }
    置特性节点(新特性: 特性_): 特性_;
    //@@{ 置特性节点NS:setAttributeNodeNS, 特性_:Attr }
    置特性节点NS(新特性: 特性_): 特性_;
    //@@{ 置特性NS:setAttributeNS }
    置特性NS(名称空间URI: 文字, 限定名: 文字, 值: 文字): 无值;
    //@@{ 置指针捕获:setPointerCapture }
    置指针捕获(指针Id: 数字): 无值;
    //@@{ webkit匹配选择:webkitMatchesSelector }
    webkit匹配选择(选择: 文字): 真假;
    //@@{ webkit请求全屏:webkitRequestFullscreen }
    webkit请求全屏(): 无值;
    //@@{ webkit请求全屏目:webkitRequestFullScreen }
    webkit请求全屏目(): 无值;
    //@@{ 取元素按类名称:getElementsByClassName, 节点列表的_:NodeListOf, 元素_:Element }
    取元素按类名称(类名: 文字): 节点列表的_<元素_>;
    //@@{ 匹配:matches }
    匹配(选择: 文字): 真假;
    //@@{ 最近的:closest, 元素_:Element }
    最近的(选择: 文字): 元素_ | 空值;
    //@@{ 滚动到视图:scrollIntoView, 滚动到视图选项_:ScrollIntoViewOptions }
    ...
    //@@{ 滚动从:scrollBy }
    滚动从(x: 数字, y: 数字): 无值;
    //@@{ 插入相邻元素:insertAdjacentElement, 插入位置_:InsertPosition, 元素_:Element }
    插入相邻元素(位置: 插入位置_, 插入元素: 元素_): 元素_ | 空值;
    //@@{ 插入相邻HTML:insertAdjacentHTML, 插入位置_:InsertPosition }
    插入相邻HTML(哪里: 插入位置_, html: 文字): 无值;
    //@@{ 插入相邻文本:insertAdjacentText, 插入位置_:InsertPosition }
    插入相邻文本(哪里: 插入位置_, 文本: 文字): 无值;
    //@@{ 附加阴影:attachShadow, 影子根初始化_:ShadowRootInit, 影子根_:ShadowRoot }
    附加阴影(阴影根初始化词典: 影子根初始化_): 影子根_;
    //@@{ 添加事件监听器:addEventListener, 元素事件映射_:ElementEventMap, 元素_:Element }
...
声明 值量 错误事件_: {
    ...
    原型: 错误事件_;
    //@@{ 错误事件初始化_:ErrorEventInit, 错误事件_:ErrorEvent }
...
//@@{ 事件目标_:EventTarget }
接口 事件目标_ {
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject, 添加事件监听器选项_:AddEventListenerOptions }
...
接口 扩展脚本API组_ {
    ...
    扩展Id到短Id(扩展Id: 文字): 数字;
    //@@{ 火狐扩展API遥测:fireExtensionApiTelemetry }
    火狐扩展API遥测(函数名: 文字, 是成功的: 真假, 是支持的: 真假): 无值;
    //@@{ 泛型函数:genericFunction }
    泛型函数(路由地址: 任意, 参数?: 文字, 回调Id?: 数字): 无值;
    //@@{ 泛型同步函数:genericSynchronousFunction }
    泛型同步函数(函数Id: 数字, 参数?: 文字): 文字;
    //@@{ 取扩展Id:getExtensionId }
    取扩展Id(): 文字;
    //@@{ 注册泛型函数回调处理程序:registerGenericFunctionCallbackHandler }
    注册泛型函数回调处理程序(回调处理程序: 任意): 无值;
    //@@{ 注册泛型持续的回调处理程序:registerGenericPersistentCallbackHandler }
...
声明 值量 文件_: {
    ...
    原型: 文件_;
    //@@{ 数组缓冲区_:ArrayBuffer, 数组缓冲区视图_:ArrayBufferView, 二进制对象_:Blob, 文件属性包_:FilePropertyBag, 文件_:File }
...
接口 文件阅读器_ 扩展 事件目标_, MS基读者_ {
    ...
    只读 错误: 文档错误_;
    //@@{ 读转为数组缓冲区:readAsArrayBuffer, 二进制对象_:Blob }
    读转为数组缓冲区(二进制对象: 二进制对象_): 无值;
    //@@{ 读转为二进制字符串:readAsBinaryString, 二进制对象_:Blob }
    读转为二进制字符串(二进制对象: 二进制对象_): 无值;
    //@@{ 读转为数据URL:readAsDataURL, 二进制对象_:Blob }
    读转为数据URL(二进制对象: 二进制对象_): 无值; 
    //@@{ 读转为文本:readAsText, 二进制对象_:Blob }
    读转为文本(二进制对象: 二进制对象_, 编码?: 文字): 无值;
    //@@{ 添加事件监听器:addEventListener, MS基读者事件映射_:MSBaseReaderEventMap, 文件阅读器_:FileReader }
...
接口 焦点事件_ 扩展 UI事件_ {
    //@@{ 相关目标:relatedTarget, 事件目标_:EventTarget }
    只读 相关目标: 事件目标_;
    //@@{ 初始化焦点事件:initFocusEvent, 窗口_:Window, 事件目标_:EventTarget }
...
声明 值量 焦点事件_: {
    ...
    原型: 焦点事件_;
    //@@{ 焦点事件初始化_:FocusEventInit, 焦点事件_:FocusEvent }
...
//@@{ 焦点导航事件_:FocusNavigationEvent }
声明 值量 焦点导航事件_: {
    //@@{ 原型:prototype, 焦点导航事件_:FocusNavigationEvent }
    原型: 焦点导航事件_;
    //@@{ 焦点导航事件初始化_:FocusNavigationEventInit, 焦点导航事件_:FocusNavigationEvent }
    新建(类型: 文字, 事件初始化词典?: 焦点导航事件初始化_): 焦点导航事件_;

};
//@@{ 表单数据_:FormData }
接口 表单数据_ {
    //@@{ 附加:append, 二进制对象_:Blob }
    附加(名字: 文字, 值: 文字 | 二进制对象_, 文件名称?: 文字): 无值;
    //@@{ 删除:delete }
    删除(名字: 文字): 无值;
    //@@{ 获取:get, 表单数据输入值_:FormDataEntryValue }
    获取(名字: 文字): 表单数据输入值_ | 空值;
    //@@{ 取所有:getAll, 表单数据输入值_:FormDataEntryValue }
    取所有(名字: 文字): 表单数据输入值_[];
    //@@{ 存在:has }
    存在(名字: 文字): 真假;
    //@@{ 设置:set, 二进制对象_:Blob }
...
声明 值量 表单数据_: {
    ...
    原型: 表单数据_;
    //@@{ HTML表单元素_:HTMLFormElement, 表单数据_:FormData }
...
声明 值量 手柄事件_: {
    ...
    原型: 手柄事件_;
    //@@{ 手柄事件初始化_:GamepadEventInit, 手柄事件_:GamepadEvent }
...
接口 地理位置_ {
    //@@{ 清除观察:clearWatch }
    清除观察(观察Id: 数字): 无值;
    //@@{ 取当前位置:getCurrentPosition, 位置回调_:PositionCallback, 位置错误回调_:PositionErrorCallback, 位置选项_:PositionOptions }
    取当前位置(成功回调: 位置回调_, 错误回调?: 位置错误回调_, 选项?: 位置选项_): 无值;
    //@@{ 观察位置:watchPosition, 位置回调_:PositionCallback, 位置错误回调_:PositionErrorCallback, 位置选项_:PositionOptions }
...
//@@{ 哈希改变事件_:HashChangeEvent }
声明 值量 哈希改变事件_: {
    //@@{ 原型:prototype, 哈希改变事件_:HashChangeEvent }
    原型: 哈希改变事件_;
    //@@{ 哈希改变事件初始化_:HashChangeEventInit, 哈希改变事件_:HashChangeEvent }
...
接口 报头_ {
    ...
    //@@{ 删除:delete }
    删除(名字: 文字): 无值;
    //@@{ 循环执行:forEach, 循环执行回调_:ForEachCallback }
    循环执行(回调: 循环执行回调_): 无值;
    //@@{ 获取:get }
    获取(名字: 文字): 文字 | 空值;
    //@@{ 存在:has }
...
接口 HTML所有集合_ {
    //@@{ 长度:length }
    只读 长度: 数字;
    //@@{ 项目:item, HTML集合_:HTMLCollection, 元素_:Element }
    项目(名称或索引?: 文字): HTML集合_ | 元素_ | 空值;
    //@@{ 命名项目:namedItem, HTML集合_:HTMLCollection, 元素_:Element }
...
接口 HTML超链接元素_ 扩展 HTML元素_ {
    ...
    //@@{ 转为文字:toString }
    转为文字(): 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML超链接元素_:HTMLAnchorElement }
...
接口 HTML应用程序元素_ 扩展 HTML元素_ {
    ...
    //@@{ 宽度:width }
    宽度: 数字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML应用程序元素_:HTMLAppletElement }
...
接口 HTML区域元素_ 扩展 HTML元素_ {
    ...
    //@@{ 转为文字:toString }
    转为文字(): 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML区域元素_:HTMLAreaElement }
...
接口 HTML音频元素_ 扩展 HTML媒体元素_ {
    //@@{ 添加事件监听器:addEventListener, HTML媒体元素事件映射_:HTMLMediaElementEventMap, HTML音频元素_:HTMLAudioElement }
...
接口 HTML基元素_ 扩展 HTML元素_ {
    ...
    //@@{ 目标:target }
    目标: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML基元素_:HTMLBaseElement }
...
接口 HTML基字体元素_ 扩展 HTML元素_, DOML2弃用颜色属性_ {
    ...
    //@@{ 大小:size }
    大小: 数字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML基字体元素_:HTMLBaseFontElement }
...
接口 HTML体元素_ 扩展 HTML元素_ {
    ...
    //@@{ 已访问连接:vLink }
    已访问连接: 任意;
    //@@{ 添加事件监听器:addEventListener, HTML体元素事件映射_:HTMLBodyElementEventMap, HTML体元素_:HTMLBodyElement }
...
接口 HTML换行元素_ 扩展 HTML元素_ {
    ...
    //@@{ 清除:clear }
    清除: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML换行元素_:HTMLBRElement }
...
接口 HTML按钮元素_ 扩展 HTML元素_ {
    ...
    置自定义有效性(错误: 文字): 无值;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML按钮元素_:HTMLButtonElement }
...
接口 HTML画板元素_ 扩展 HTML元素_ {
     ...
     */
    //@@{ 取上下文:getContext, 画板2D上下文特性_:Canvas2DContextAttributes, 画板渲染上下文2D_:CanvasRenderingContext2D }
    取上下文(上下文Id: "2d", 上下文特性?: 画板2D上下文特性_): 画板渲染上下文2D_ | 空值;
    //@@{ 取上下文:getContext, WebGL上下文属性_:WebGLContextAttributes, WebGL渲染上下文_:WebGLRenderingContext }
    取上下文(上下文Id: "webgl" | "experimental-webgl", 上下文特性?: WebGL上下文属性_): WebGL渲染上下文_ | 空值;
    //@@{ 取上下文:getContext, 画板渲染上下文2D_:CanvasRenderingContext2D, WebGL渲染上下文_:WebGLRenderingContext }
    ...
    //@@{ 转为二进制对象:toBlob, 二进制对象_:Blob }
    转为二进制对象(回调: (结果: 二进制对象_ | 空值) => 无值, 类型?: 文字, ...增强参数组: 任意[]): 无值;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML画板元素_:HTMLCanvasElement }
...
接口 HTML数据元素_ 扩展 HTML元素_ {
    //@@{ 值:value }
    值: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML数据元素_:HTMLDataElement }
...
接口 HTML数据列表元素_ 扩展 HTML元素_ {
    ...
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML数据列表元素_:HTMLDataListElement }
...
接口 HTML目录元素_ 扩展 HTML元素_ {
    //@@{ 紧凑的:compact }
    紧凑的: 真假;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML目录元素_:HTMLDirectoryElement }
...
接口 HTML块元素_ 扩展 HTML元素_ {
    ...
    //@@{ 不换行:noWrap }
    不换行: 真假;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML块元素_:HTMLDivElement }
...
接口 HTML列表元素_ 扩展 HTML元素_ {
    //@@{ 紧凑的:compact }
    紧凑的: 真假;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML列表元素_:HTMLDListElement }
...
接口 HTML文档_ 扩展 文档_ {
    //@@{ 添加事件监听器:addEventListener, 文档事件映射_:DocumentEventMap, HTML文档_:HTMLDocument }
...
接口 HTML元素_ 扩展 元素_ {
    ...
    ms取输入上下文(): MS输入法上下文_;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML元素_:HTMLElement }
...
接口 HTML嵌入元素_ 扩展 HTML元素_, 取SVG文档_ {
    ...
    //@@{ 宽度:width }
    宽度: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML嵌入元素_:HTMLEmbedElement }
...
接口 HTML分组元素_ 扩展 HTML元素_ {
    ...
    //@@{ 置自定义有效性:setCustomValidity }
    置自定义有效性(错误: 文字): 无值;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML分组元素_:HTMLFieldSetElement }
...
接口 HTML字体元素_ 扩展 HTML元素_, DOML2弃用颜色属性_, DOML2弃用大小属性_ {
    ...
    //@@{ 家族:face }
    家族: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML字体元素_:HTMLFontElement }
...
接口 HTML表单元素_ 扩展 HTML元素_ {
    ...
    报告有效性(): 真假;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML表单元素_:HTMLFormElement }
...
接口 HTML框架元素_ 扩展 HTML元素_, 取SVG文档_ {
    ...
    //@@{ 宽度:width }
    宽度: 文字 | 数字;
    //@@{ 添加事件监听器:addEventListener, HTML框架元素事件映射_:HTMLFrameElementEventMap, HTML框架元素_:HTMLFrameElement }
...
接口 HTML框架分组元素_ 扩展 HTML元素_ {
    ...
    //@@{ 行:rows }
    行: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML框架分组元素事件映射_:HTMLFrameSetElementEventMap, HTML框架分组元素_:HTMLFrameSetElement }
...
接口 HTML头部元素_ 扩展 HTML元素_ {
    //@@{ 配置文件:profile }
    配置文件: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML头部元素_:HTMLHeadElement }
...
接口 HTML标题元素_ 扩展 HTML元素_ {
    ...
    //@@{ 对齐:align }
    对齐: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML标题元素_:HTMLHeadingElement }
...
接口 HTML水平线元素_ 扩展 HTML元素_, DOML2弃用颜色属性_, DOML2弃用大小属性_ {
    ...
    //@@{ 宽度:width }
    宽度: 数字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML水平线元素_:HTMLHRElement }
...
接口 HTML超文本标记元素_ 扩展 HTML元素_ {
    ...
    //@@{ 版本:version }
    版本: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML超文本标记元素_:HTMLHtmlElement }
...
接口 HTML内联框架元素_ 扩展 HTML元素_, 取SVG文档_ {
    ...
    //@@{ 宽度:width }
    宽度: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML内联框架元素事件映射_:HTMLIFrameElementEventMap, HTML内联框架元素_:HTMLIFrameElement }
...
接口 HTML图像元素_ 扩展 HTML元素_ {
    ...
    ms取转为媒体源(): 任意;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML图像元素_:HTMLImageElement }
...
接口 HTML输入元素_ 扩展 HTML元素_ {
    ...
    //@@{ 增加步幅:stepUp }
    增加步幅(n?: 数字): 无值;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML输入元素_:HTMLInputElement }
...
接口 HTML标签元素_ 扩展 HTML元素_ {
    ...
    //@@{ 绑定表单:htmlFor }
    绑定表单: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML标签元素_:HTMLLabelElement }
...
接口 HTML分组标题元素_ 扩展 HTML元素_ {
    ...
    //@@{ 表单:form, HTML表单元素_:HTMLFormElement }
    只读 表单: HTML表单元素_ | 空值;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML分组标题元素_:HTMLLegendElement }
...
接口 HTML列表项元素_ 扩展 HTML元素_ {
    ...
    //@@{ 值:value }
    值: 数字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML列表项元素_:HTMLLIElement }
...
接口 HTML外部样式元素_ 扩展 HTML元素_, 链接样式_ {
    ...
    //@@{ 完整性:integrity }
    完整性: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML外部样式元素_:HTMLLinkElement }
...
接口 HTML图像映射元素_ 扩展 HTML元素_ {
    ...
    //@@{ 名字:name }
    名字: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML图像映射元素_:HTMLMapElement }
...
接口 HTML字幕元素_ 扩展 HTML元素_ {
    ...
    //@@{ 停止:stop }
    停止(): 无值;
    //@@{ 添加事件监听器:addEventListener, HTML字幕元素事件映射_:HTMLMarqueeElementEventMap, HTML字幕元素_:HTMLMarqueeElement }
...
接口 HTML媒体元素_ 扩展 HTML元素_ {
    ...
    //@@{ 音量:volume }
    音量: 数字;
    //@@{ 添加文本轨道:addTextTrack, 文本轨道_:TextTrack }
    ...
    //@@{ ms设置媒体键:msSetMediaKeys, MS媒体键组_:MSMediaKeys }
    ms设置媒体键(媒体键: MS媒体键组_): 无值;

    /**
     * Specifies the media protection manager for a given media pipeline.
     */
    //@@{ ms设置媒体保护管理者:msSetMediaProtectionManager }
    ...
    //@@{ 播放:play, 预设_:Promise }
    播放(): 预设_<无值>;
    //@@{ 置媒体键组:setMediaKeys, 媒体键组_:MediaKeys, 预设_:Promise }
    ...
    只读 __网络_没有_源__: 数字;
    //@@{ 添加事件监听器:addEventListener, HTML媒体元素事件映射_:HTMLMediaElementEventMap, HTML媒体元素_:HTMLMediaElement }
...
接口 HTML菜单元素_ 扩展 HTML元素_ {
    ...
    //@@{ 类型:type }
    类型: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML菜单元素_:HTMLMenuElement }
...
接口 HTML元数据元素_ 扩展 HTML元素_ {
     ...
     */
    url: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML元数据元素_:HTMLMetaElement }
...
接口 HTML度量表元素_ 扩展 HTML元素_ {
    ...
    //@@{ 值:value }
    值: 数字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML度量表元素_:HTMLMeterElement }
...
接口 HTML模板元素_ 扩展 HTML元素_ {
    ...
    //@@{ 日期时间:dateTime }
    日期时间: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML模板元素_:HTMLModElement }
...
接口 HTML对象元素_ 扩展 HTML元素_, 取SVG文档_ {
    ...
    //@@{ 置自定义有效性:setCustomValidity }
    置自定义有效性(错误: 文字): 无值;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML对象元素_:HTMLObjectElement }
...
接口 HTML有序列表元素_ 扩展 HTML元素_ {
    ...
    //@@{ 类型:type }
    类型: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML有序列表元素_:HTMLOListElement }
...
接口 HTML选项组元素_ 扩展 HTML元素_ {
    ...
    //@@{ 值:value }
    值: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML选项组元素_:HTMLOptGroupElement }
...
接口 HTML选项元素_ 扩展 HTML元素_ {
    ...
    //@@{ 值:value }
    值: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML选项元素_:HTMLOptionElement }
...
接口 HTML选项集合_ 扩展 HTML集合的_<HTML选项元素_> {
    ...
    //@@{ 选择的索引:selectedIndex }
    选择的索引: 数字;
    //@@{ 添加:add, HTML选项元素_:HTMLOptionElement, HTML选项组元素_:HTMLOptGroupElement, HTML元素_:HTMLElement }
...
接口 HTML输出元素_ 扩展 HTML元素_ {
    ...
    //@@{ 置自定义有效性:setCustomValidity }
    置自定义有效性(错误: 文字): 无值;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML输出元素_:HTMLOutputElement }
...
接口 HTML段落元素_ 扩展 HTML元素_ {
    ...
    //@@{ 清除:clear }
    清除: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML段落元素_:HTMLParagraphElement }
...
接口 HTML参数元素_ 扩展 HTML元素_ {
    ...
    //@@{ 值类型:valueType }
    值类型: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML参数元素_:HTMLParamElement }
...
接口 HTML照片元素_ 扩展 HTML元素_ {
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML照片元素_:HTMLPictureElement }
...
接口 HTML预处理元素_ 扩展 HTML元素_ {
    ...
    //@@{ 宽度:width }
    宽度: 数字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML预处理元素_:HTMLPreElement }
...
接口 HTML进度元素_ 扩展 HTML元素_ {
    ...
    //@@{ 值:value }
    值: 数字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML进度元素_:HTMLProgressElement }
...
接口 HTML引用元素_ 扩展 HTML元素_ {
    ...
    //@@{ 引用:cite }
    引用: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML引用元素_:HTMLQuoteElement }
...
接口 HTML脚本元素_ 扩展 HTML元素_ {
    ...
    //@@{ 完整性:integrity }
    完整性: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML脚本元素_:HTMLScriptElement }
...
接口 HTML选择元素_ 扩展 HTML元素_ {
    ...
    //@@{ 置自定义有效性:setCustomValidity }
    置自定义有效性(错误: 文字): 无值;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML选择元素_:HTMLSelectElement }
...
接口 HTML来源元素_ 扩展 HTML元素_ {
    ...
    //@@{ 类型:type }
    类型: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML来源元素_:HTMLSourceElement }
...
接口 HTML跨度元素_ 扩展 HTML元素_ {
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML跨度元素_:HTMLSpanElement }
...
接口 HTML样式元素_ 扩展 HTML元素_, 链接样式_ {
    ...
    //@@{ 类型:type }
    类型: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML样式元素_:HTMLStyleElement }
...
接口 HTML表标题元素_ 扩展 HTML元素_ {
    ...
    //@@{ 垂直对齐:vAlign }
    垂直对齐: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML表标题元素_:HTMLTableCaptionElement }
...
接口 HTML表单元格元素_ 扩展 HTML元素_, HTML表校准_ {
    ...
    //@@{ 宽度:width }
    宽度: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML表单元格元素_:HTMLTableCellElement }
...
接口 HTML表列元素_ 扩展 HTML元素_, HTML表校准_ {
    ...
    //@@{ 宽度:width }
    宽度: 任意; 
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML表列元素_:HTMLTableColElement }
...
接口 HTML表数据单元格元素_ 扩展 HTML表单元格元素_ {
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML表数据单元格元素_:HTMLTableDataCellElement }
...
接口 HTML表元素_ 扩展 HTML元素_ {
     ...
     */
    //@@{ 插入行:insertRow, HTML表行元素_:HTMLTableRowElement }
    插入行(索引?: 数字): HTML表行元素_;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML表元素_:HTMLTableElement }
...
接口 HTML表头单元格_ 扩展 HTML表单元格元素_ {
    ...
    //@@{ 范围:scope }
    范围: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML表头单元格_:HTMLTableHeaderCellElement }
...
接口 HTML表行元素_ 扩展 HTML元素_, HTML表校准_ {
     ...
     */
    //@@{ 插入单元格:insertCell, HTML表数据单元格元素_:HTMLTableDataCellElement }
    插入单元格(索引?: 数字): HTML表数据单元格元素_;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML表行元素_:HTMLTableRowElement }
...
接口 HTML表部分元素_ 扩展 HTML元素_, HTML表校准_ {
    ...
    //@@{ 插入行:insertRow, HTML表行元素_:HTMLTableRowElement }
    插入行(索引?: 数字): HTML表行元素_;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML表部分元素_:HTMLTableSectionElement }
...
接口 HTML文本区域元素_ 扩展 HTML元素_ {
    ...
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML文本区域元素_:HTMLTextAreaElement }
...
接口 HTML时间元素_ 扩展 HTML元素_ {
    //@@{ 日期时间:dateTime }
    日期时间: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML时间元素_:HTMLTimeElement }
...
接口 HTML轨道元素_ 扩展 HTML元素_ {
    ...
    //@@{ __没有__:NONE }
    只读 __没有__: 数字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML轨道元素_:HTMLTrackElement }
...
接口 HTML无序列表元素_ 扩展 HTML元素_ {
    ...
    //@@{ 类型:type }
    类型: 文字;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML无序列表元素_:HTMLUListElement }
...
接口 HTML未知元素_ 扩展 HTML元素_ {
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, HTML未知元素_:HTMLUnknownElement }
...
接口 HTML视频元素_ 扩展 HTML媒体元素_ {
    ...
    webkit退出全屏了(): 无值;
    //@@{ 添加事件监听器:addEventListener, HTML视频元素事件映射_:HTMLVideoElementEventMap, HTML视频元素_:HTMLVideoElement }
...
接口 IDB光标_ {
    ...
    //@@{ 推进:advance }
    推进(数: 数字): 无值;
    //@@{ 继续:continue, IDB键范围_:IDBKeyRange, IDB有效键:IDBValidKey }
    继续(键?: IDB键范围_ | IDB有效键): 无值;
    //@@{ 删除:delete, IDB请求_:IDBRequest }
    删除(): IDB请求_;
    //@@{ 更新:update, IDB请求_:IDBRequest }
    更新(值: 任意): IDB请求_;
    //@@{ __下个__:NEXT }
    只读 __下个__: 文字;
...
接口 IDB数据库_ 扩展 事件目标_ {
    ...
    //@@{ 关闭:close }
    关闭(): 无值;
    //@@{ 创建对象存储:createObjectStore, IDB对象存储参数_:IDBObjectStoreParameters, IDB对象存储_:IDBObjectStore }
    创建对象存储(名字: 文字, 可选参数?: IDB对象存储参数_): IDB对象存储_;
    //@@{ 删除对象存储:deleteObjectStore }
    删除对象存储(名字: 文字): 无值;
    //@@{ 事务:transaction, IDB事务模式_:IDBTransactionMode, IDB事务_:IDBTransaction }
    事务(库名称: 文字 | 文字[], 模式?: IDB事务模式_): IDB事务_;
    //@@{ 添加事件监听器:addEventListener, IDB版本改变事件_:IDBVersionChangeEvent }
    添加事件监听器(类型: "版本改变", 侦听器: (ev: IDB版本改变事件_) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, IDB数据库事件映射_:IDBDatabaseEventMap, IDB数据库_:IDBDatabase }
...
接口 IDB工厂_ {
    //@@{ 比较:cmp }
    比较(第一个: 任意, 第二个: 任意): 数字;
    //@@{ 删除数据库:deleteDatabase, IDB打开数据库请求_:IDBOpenDBRequest }
    删除数据库(名字: 文字): IDB打开数据库请求_;
    //@@{ 打开:open, IDB打开数据库请求_:IDBOpenDBRequest }
...
接口 IDB索引_ {
    ...
    //@@{ 多条目:multiEntry }
    多条目: 真假;
    //@@{ 数量:count, IDB键范围_:IDBKeyRange, IDB有效键:IDBValidKey, IDB请求_:IDBRequest }
    数量(键?: IDB键范围_ | IDB有效键): IDB请求_;
    //@@{ 获取:get, IDB键范围_:IDBKeyRange, IDB有效键:IDBValidKey, IDB请求_:IDBRequest }
    获取(键: IDB键范围_ | IDB有效键): IDB请求_;
    //@@{ 取键:getKey, IDB键范围_:IDBKeyRange, IDB有效键:IDBValidKey, IDB请求_:IDBRequest }
    取键(键: IDB键范围_ | IDB有效键): IDB请求_;
    //@@{ 打开游标:openCursor, IDB键范围_:IDBKeyRange, IDB有效键:IDBValidKey, IDB光标方向_:IDBCursorDirection, IDB请求_:IDBRequest }
    打开游标(范围?: IDB键范围_ | IDB有效键, 方向?: IDB光标方向_): IDB请求_;
    //@@{ 打开键游标:openKeyCursor, IDB键范围_:IDBKeyRange, IDB有效键:IDBValidKey, IDB光标方向_:IDBCursorDirection, IDB请求_:IDBRequest }
...
声明 值量 IDB键范围_: {
    ...
    //@@{ IDB键范围_:IDBKeyRange }
    新建(): IDB键范围_;
    //@@{ 绑定:bound, IDB键范围_:IDBKeyRange }
    绑定(较低的: 任意, 较高的: 任意, 较低打开?: 真假, 较高打开?: 真假): IDB键范围_;
    //@@{ 较低绑定:lowerBound, IDB键范围_:IDBKeyRange }
    较低绑定(较低的: 任意, 打开?: 真假): IDB键范围_;
    //@@{ 只有:only, IDB键范围_:IDBKeyRange }
    只有(值: 任意): IDB键范围_;
    //@@{ 较高绑定:upperBound, IDB键范围_:IDBKeyRange }
...
接口 IDB对象存储_ {
    ...
    //@@{ 自动增量:autoIncrement }
    自动增量: 真假;
    //@@{ 添加:add, IDB键范围_:IDBKeyRange, IDB有效键:IDBValidKey, IDB请求_:IDBRequest }
    添加(值: 任意, 键?: IDB键范围_ | IDB有效键): IDB请求_;
    //@@{ 清除:clear, IDB请求_:IDBRequest }
    清除(): IDB请求_;
    //@@{ 数量:count, IDB键范围_:IDBKeyRange, IDB有效键:IDBValidKey, IDB请求_:IDBRequest }
    数量(键?: IDB键范围_ | IDB有效键): IDB请求_;
    //@@{ 创建索引:createIndex, IDB索引参数_:IDBIndexParameters, IDB索引_:IDBIndex }
    创建索引(名字: 文字, 键路径: 文字 | 文字[], 可选参数?: IDB索引参数_): IDB索引_;
    //@@{ 删除:delete, IDB键范围_:IDBKeyRange, IDB有效键:IDBValidKey, IDB请求_:IDBRequest }
    删除(键: IDB键范围_ | IDB有效键): IDB请求_;
    //@@{ 删除索引:deleteIndex }
    删除索引(索引名称: 文字): 无值;
    //@@{ 获取:get, IDB请求_:IDBRequest }
    获取(键: 任意): IDB请求_;
    //@@{ 索引:index, IDB索引_:IDBIndex }
    索引(名字: 文字): IDB索引_;
    //@@{ 打开游标:openCursor, IDB键范围_:IDBKeyRange, IDB有效键:IDBValidKey, IDB光标方向_:IDBCursorDirection, IDB请求_:IDBRequest }
    打开游标(范围?: IDB键范围_ | IDB有效键, 方向?: IDB光标方向_): IDB请求_;
    //@@{ 更新:put, IDB键范围_:IDBKeyRange, IDB有效键:IDBValidKey, IDB请求_:IDBRequest }
...
接口 IDB打开数据库请求_ 扩展 IDB请求_ {
    ...
    //@@{ 添加事件监听器:addEventListener, IDB打开数据库请求事件映射_:IDBOpenDBRequestEventMap, IDB打开数据库请求_:IDBOpenDBRequest }
...
接口 IDB请求_ 扩展 事件目标_ {
    ...
    //@@{ 事务:transaction, IDB事务_:IDBTransaction }
    只读 事务: IDB事务_;
    //@@{ 添加事件监听器:addEventListener, IDB请求事件映射_:IDBRequestEventMap, IDB请求_:IDBRequest }
...
接口 IDB事务_ 扩展 事件目标_ {
    ...
    只读 __版本_改变__: 文字;
    //@@{ 添加事件监听器:addEventListener, IDB事务事件映射_:IDBTransactionEventMap, IDB事务_:IDBTransaction }
...
声明 值量 图像数据_: {
    ...
    //@@{ 正整数固定数组8_:Uint8ClampedArray, 图像数据_:ImageData }
...
声明 值量 交叉观察者_: {
    ...
    原型: 交叉观察者_;
    //@@{ 交叉观察者回调_:IntersectionObserverCallback, 交集观察者初始化_:IntersectionObserverInit, 交叉观察者_:IntersectionObserver }
...
声明 值量 交叉观察者条目_: {
    ...
    原型: 交叉观察者条目_;
    //@@{ 交集观察者条目初始化_:IntersectionObserverEntryInit, 交叉观察者条目_:IntersectionObserverEntry }
...
接口 键盘事件_ 扩展 UI事件_ {
    ...
    取修饰符状态(键参数: 文字): 真假;
    //@@{ 初始化键盘事件:initKeyboardEvent, 窗口_:Window }
...
声明 值量 键盘事件_: {
    ...
    原型: 键盘事件_;
    //@@{ 键盘事件初始化_:KeyboardEventInit, 键盘事件_:KeyboardEvent }
...
接口 媒体设备_ 扩展 事件目标_ {
    ...
    取支持约束(): 媒体轨道支持约束_;
    //@@{ 取用户媒体:getUserMedia, 媒体流约束_:MediaStreamConstraints, 预设_:Promise, 媒体流_:MediaStream }
    取用户媒体(约束: 媒体流约束_): 预设_<媒体流_>;
    //@@{ 添加事件监听器:addEventListener, 媒体设备事件映射_:MediaDevicesEventMap, 媒体设备_:MediaDevices }
...
声明 值量 媒体加密事件_: {
    ...
    原型: 媒体加密事件_;
    //@@{ 媒体加密事件初始化_:MediaEncryptedEventInit, 媒体加密事件_:MediaEncryptedEvent }
...
//@@{ 媒体键消息事件_:MediaKeyMessageEvent }
声明 值量 媒体键消息事件_: {
    //@@{ 原型:prototype, 媒体键消息事件_:MediaKeyMessageEvent }
    原型: 媒体键消息事件_;
    //@@{ 媒体键消息事件初始化_:MediaKeyMessageEventInit, 媒体键消息事件_:MediaKeyMessageEvent }
    新建(类型: 文字, 事件初始化词典?: 媒体键消息事件初始化_): 媒体键消息事件_;

};
//@@{ 媒体键组_:MediaKeys }
接口 媒体键组_ {
    //@@{ 创建会话:createSession, 媒体键会话类型_:MediaKeySessionType, 媒体会话密钥_:MediaKeySession }
    创建会话(会话类型?: 媒体键会话类型_): 媒体会话密钥_;
    //@@{ 置服务器证书:setServerCertificate, 预设_:Promise }
...
接口 媒体会话密钥_ 扩展 事件目标_ {
    ...
    //@@{ 关闭:close, 预设_:Promise }
    关闭(): 预设_<无值>;
    //@@{ 生成请求:generateRequest, 预设_:Promise }
...
接口 媒体查询列表_ {
    ...
    //@@{ 媒体:media }
    只读 媒体: 文字;
    //@@{ 添加监听器:addListener, 媒体查询列表侦听器_:MediaQueryListListener }
    添加监听器(侦听器: 媒体查询列表侦听器_): 无值;
    //@@{ 删除监听器:removeListener, 媒体查询列表侦听器_:MediaQueryListListener }
...
接口 媒体来源_ 扩展 事件目标_ {
    ...
    只读 源缓冲区: 源缓冲区列表_;
    //@@{ 添加源缓冲区:addSourceBuffer, 源缓冲区_:SourceBuffer }
    添加源缓冲区(类型: 文字): 源缓冲区_;
    //@@{ 流的结束:endOfStream }
    流的结束(错误?: 数字): 无值;
    //@@{ 删除源缓冲区:removeSourceBuffer, 源缓冲区_:SourceBuffer }
...
接口 媒体流事件映射_ {
    //@@{ 事件_:Event }
    "活动": 事件_;
    //@@{ 媒体流轨道事件_:MediaStreamTrackEvent }
    "添加轨道": 媒体流轨道事件_;
    //@@{ 事件_:Event }
    "闲置": 事件_;
    //@@{ 媒体流轨道事件_:MediaStreamTrackEvent }
...
接口 媒体流_ 扩展 事件目标_ {
    ...
    //@@{ 添加轨道:addTrack, 媒体流轨道_:MediaStreamTrack }
    添加轨道(轨道: 媒体流轨道_): 无值;
    //@@{ 克隆:clone, 媒体流_:MediaStream }
    克隆(): 媒体流_;
    //@@{ 取音频轨道:getAudioTracks, 媒体流轨道_:MediaStreamTrack }
    取音频轨道(): 媒体流轨道_[];
    //@@{ 取轨道按Id:getTrackById, 媒体流轨道_:MediaStreamTrack }
    取轨道按Id(轨道Id: 文字): 媒体流轨道_ | 空值;
    //@@{ 取轨道组:getTracks, 媒体流轨道_:MediaStreamTrack }
    取轨道组(): 媒体流轨道_[];
    //@@{ 取视频轨道组:getVideoTracks, 媒体流轨道_:MediaStreamTrack }
    取视频轨道组(): 媒体流轨道_[];
    //@@{ 删除轨道:removeTrack, 媒体流轨道_:MediaStreamTrack }
    删除轨道(轨道: 媒体流轨道_): 无值;
    //@@{ 停止:stop }
    停止(): 无值;
    //@@{ 添加事件监听器:addEventListener, 媒体流事件映射_:MediaStreamEventMap, 媒体流_:MediaStream }
...
声明 值量 媒体流_: {
    ...
    原型: 媒体流_;
    //@@{ 媒体流_:MediaStream, 媒体流轨道_:MediaStreamTrack }
...
声明 值量 媒体流错误事件_: {
    ...
    原型: 媒体流错误事件_;
    //@@{ 媒体流错误事件初始化_:MediaStreamErrorEventInit, 媒体流错误事件_:MediaStreamErrorEvent }
...
//@@{ 媒体流事件_:MediaStreamEvent }
声明 值量 媒体流事件_: {
    //@@{ 原型:prototype, 媒体流事件_:MediaStreamEvent }
    原型: 媒体流事件_;
    //@@{ 媒体流事件初始化_:MediaStreamEventInit, 媒体流事件_:MediaStreamEvent }
...
接口 媒体流轨道_ 扩展 事件目标_ {
    ...
    //@@{ 远程:remote }
    只读 远程: 真假;
    //@@{ 应用约束:applyConstraints, 媒体轨道约束_:MediaTrackConstraints, 预设_:Promise }
    ...
    //@@{ 停止:stop }
    停止(): 无值;
    //@@{ 添加事件监听器:addEventListener, 媒体流轨道事件映射_:MediaStreamTrackEventMap, 媒体流轨道_:MediaStreamTrack }
...
声明 值量 媒体流轨道事件_: {
    ...
    原型: 媒体流轨道事件_;
    //@@{ 媒体流轨道事件初始化_:MediaStreamTrackEventInit, 媒体流轨道事件_:MediaStreamTrackEvent }
...
接口 消息事件_ 扩展 事件_ {
    ...
    只读 来源: 窗口_;
    //@@{ 初始化消息事件:initMessageEvent, 窗口_:Window }
...
声明 值量 消息事件_: {
    ...
    原型: 消息事件_;
    //@@{ 消息事件初始化_:MessageEventInit, 消息事件_:MessageEvent }
...
接口 消息端口_ 扩展 事件目标_ {
    ...
    //@@{ 开始:start }
    开始(): 无值;
    //@@{ 添加事件监听器:addEventListener, 消息端口事件映射_:MessagePortEventMap, 消息端口_:MessagePort }
...
接口 鼠标事件_ 扩展 UI事件_ {
    ...
    //@@{ 取修饰符状态:getModifierState }
    取修饰符状态(键参数: 文字): 真假;
    //@@{ 初始化鼠标事件:initMouseEvent, 窗口_:Window, 事件目标_:EventTarget }
...
声明 值量 鼠标事件_: {
    ...
    原型: 鼠标事件_;
    //@@{ 鼠标事件初始化_:MouseEventInit, 鼠标事件_:MouseEvent }
...
接口 MS应用程序_ {
    ...
    清除临时网络数据(): MS应用程序异步操作;
    //@@{ 创建二进制对象从随机访问流:createBlobFromRandomAccessStream, 二进制对象_:Blob }
    创建二进制对象从随机访问流(类型: 文字, 查询器: 任意): 二进制对象_;
    //@@{ 创建数据包:createDataPackage }
    创建数据包(对象: 任意): 任意;
    //@@{ 创建数据包从选择:createDataPackageFromSelection }
    创建数据包从选择(): 任意;
    //@@{ 创建文件从存储文件:createFileFromStorageFile, 文件_:File }
    创建文件从存储文件(存储文件: 任意): 文件_;
    //@@{ 创建流从输入流:createStreamFromInputStream, MS流_:MSStream }
    创建流从输入流(类型: 文字, 输入流: 任意): MS流_;
    //@@{ 执行异步优先:execAsyncAtPriority, MS执行在优先级函数回调_:MSExecAtPriorityFunctionCallback }
    执行异步优先(异步回调: MS执行在优先级函数回调_, 优先级: 文字, ...参数组: 任意[]): 无值;
    //@@{ 执行优先级:execAtPriority, MS执行在优先级函数回调_:MSExecAtPriorityFunctionCallback }
    执行优先级(同步回调: MS执行在优先级函数回调_, 优先级: 文字, ...参数组: 任意[]): 任意;
    //@@{ 取当前优先级:getCurrentPriority }
    取当前优先级(): 文字;
    //@@{ 取Html打印文档源异步:getHtmlPrintDocumentSourceAsync, 预设_:Promise }
    取Html打印文档源异步(html文档: 任意): 预设_<任意>;
    //@@{ 取视图Id:getViewId }
    取视图Id(view: 任意): 任意;
    //@@{ 是任务计划的优先级或更高:isTaskScheduledAtPriorityOrHigher }
    是任务计划的优先级或更高(优先级: 文字): 真假;
    //@@{ 页面处理所有应用程序激活:pageHandlesAllApplicationActivations }
    页面处理所有应用程序激活(启用: 真假): 无值;
    //@@{ 禁止子下载凭据提示:suppressSubdownloadCredentialPrompts }
    禁止子下载凭据提示(抑制: 真假): 无值;
    //@@{ 终止程序:terminateApp }
    终止程序(异常对象: 任意): 无值;
    //@@{ __当前__:CURRENT }
...
接口 MS应用程序异步操作 扩展 事件目标_ {
    ...
    //@@{ __开始__:STARTED }
    只读 __开始__: 数字;
    //@@{ 添加事件监听器:addEventListener, MS应用程序异步操作事件映射_:MSAppAsyncOperationEventMap, MS应用程序异步操作:MSAppAsyncOperation }
...
//@@{ MS凭证_:MSCredentials }
接口 MS凭证_ {
    //@@{ 取断言:getAssertion, MS凭证过滤器_:MSCredentialFilter, MS签名参数_:MSSignatureParameters, 预设_:Promise, MS断言_:MSAssertion }
    取断言(查询口令: 文字, 过滤器?: MS凭证过滤器_, 参数个组?: MS签名参数_): 预设_<MS断言_>;
    //@@{ 标记凭证:makeCredential, MS账户信息_:MSAccountInfo, MS凭证参数_:MSCredentialParameters, 预设_:Promise, MS断言_:MSAssertion }
...
接口 MS手势事件_ 扩展 UI事件_ {
    ...
    //@@{ 速度Y:velocityY }
    只读 速度Y: 数字;
    //@@{ 初始化手势事件:initGestureEvent, 窗口_:Window }
...
接口 MSHTML网络视图元素_ 扩展 HTML元素_ {
    ...
    //@@{ 向前去:goForward }
    向前去(): 无值;
    //@@{ 异步调用脚本:invokeScriptAsync, MS网络视图异步操作_:MSWebViewAsyncOperation }
    异步调用脚本(脚本名称: 文字, ...参数组: 任意[]): MS网络视图异步操作_;
    //@@{ 导航:navigate }
    导航(uri: 文字): 无值;
    //@@{ 导航焦点:navigateFocus, 导航原因_:NavigationReason, 焦点导航起源_:FocusNavigationOrigin }
    导航焦点(导航原因: 导航原因_, 起点: 焦点导航起源_): 无值;
    //@@{ 导航到本地流Uri:navigateToLocalStreamUri }
    导航到本地流Uri(源: 文字, 流解析器: 任意): 无值;
    //@@{ 导航到字符串:navigateToString }
    导航到字符串(内容: 文字): 无值;
    //@@{ 使用Http请求消息导航:navigateWithHttpRequestMessage }
    使用Http请求消息导航(请求消息: 任意): 无值;
    //@@{ 刷新:refresh }
    刷新(): 无值;
    //@@{ 停止:stop }
    停止(): 无值;
    //@@{ 添加事件监听器:addEventListener, HTML元素事件映射_:HTMLElementEventMap, MSHTML网络视图元素_:MSHTMLWebViewElement }
...
接口 MS输入法上下文_ 扩展 事件目标_ {
    ...
    是可见候选窗口(): 真假;
    //@@{ 添加事件监听器:addEventListener, MS输入法上下文事件映射_:MSInputMethodContextEventMap, MS输入法上下文_:MSInputMethodContext }
...
接口 MS操纵杆事件_ 扩展 UI事件_ {
    ...
    //@@{ 最后状态:lastState }
    只读 最后状态: 数字;
    //@@{ 初始化MS操纵杆事件:initMSManipulationEvent, 窗口_:Window }
...
接口 MS媒体键组_ {
    //@@{ 键系统:keySystem }
    只读 键系统: 文字;
    //@@{ 创建会话:createSession, 正整数数组8_:Uint8Array, MS媒体键会话_:MSMediaKeySession }
...
声明 值量 MS媒体键组_: {
    ...
    //@@{ 是支持类型与特性:isTypeSupportedWithFeatures }
...
接口 MS指针事件_ 扩展 鼠标事件_ {
    ...
    //@@{ 宽度:width }
    只读 宽度: 数字;
    //@@{ 取当前点:getCurrentPoint, 元素_:Element }
    取当前点(元素: 元素_): 无值;
    //@@{ 取中间点:getIntermediatePoints, 元素_:Element }
    取中间点(元素: 元素_): 无值;
    //@@{ 初始化指针事件:initPointerEvent, 窗口_:Window, 事件目标_:EventTarget }
...
声明 值量 MS指针事件_: {
    ...
    原型: MS指针事件_;
    //@@{ 指针事件初始化_:PointerEventInit, MS指针事件_:MSPointerEvent }
...
接口 MS流读者_ 扩展 事件目标_, MS基读者_ {
    //@@{ 错误:error, 文档错误_:DOMError }
    只读 错误: 文档错误_;
    //@@{ 读转为数组缓冲:readAsArrayBuffer, MS流_:MSStream }
    读转为数组缓冲(流: MS流_, 大小?: 数字): 无值;
    //@@{ 读转为二进制字符串:readAsBinaryString, MS流_:MSStream }
    读转为二进制字符串(流: MS流_, 大小?: 数字): 无值;
    //@@{ 读转为二进制对象:readAsBlob, MS流_:MSStream }
    读转为二进制对象(流: MS流_, 大小?: 数字): 无值;
    //@@{ 读转为数据URL:readAsDataURL, MS流_:MSStream }
    读转为数据URL(流: MS流_, 大小?: 数字): 无值;
    //@@{ 读转为文本:readAsText, MS流_:MSStream }
    读转为文本(流: MS流_, 编码?: 文字, 大小?: 数字): 无值;
    //@@{ 添加事件监听器:addEventListener, MS基读者事件映射_:MSBaseReaderEventMap, MS流读者_:MSStreamReader }
...
接口 MS网络视图异步操作_ 扩展 事件目标_ {
    ...
    只读 __类型_调用_脚本__: 数字;
    //@@{ 添加事件监听器:addEventListener, MS网络视图异步操作事件映射_:MSWebViewAsyncOperationEventMap, MS网络视图异步操作_:MSWebViewAsyncOperation }
...
接口 突变事件_ 扩展 事件_ {
    ...
    只读 相关节点: 节点_;
    //@@{ 初始化突变事件:initMutationEvent, 节点_:Node }
...
接口 突变观察者_ {
    //@@{ 断开连接:disconnect }
    断开连接(): 无值;
    //@@{ 观察:observe, 节点_:Node, 突变观察者初始化_:MutationObserverInit }
...
声明 值量 突变观察者_: {
    ...
    原型: 突变观察者_;
    //@@{ 突变回调_:MutationCallback, 突变观察者_:MutationObserver }
    新建(回调: 突变回调_): 突变观察者_;
...
接口 命名节点映射_ {
    //@@{ 长度:length }
    只读 长度: 数字;
    //@@{ 取命名项:getNamedItem, 特性_:Attr }
    取命名项(名字: 文字): 特性_;
    //@@{ 取命名项NS:getNamedItemNS, 特性_:Attr }
    取命名项NS(名称空间URI: 文字 | 空值, 本地名称: 文字 | 空值): 特性_;
    //@@{ 项目:item, 特性_:Attr }
    项目(索引: 数字): 特性_;
    //@@{ 删除命名项目:removeNamedItem, 特性_:Attr }
    删除命名项目(名字: 文字): 特性_;
    //@@{ 删除命名项NS:removeNamedItemNS, 特性_:Attr }
    删除命名项NS(名称空间URI: 文字 | 空值, 本地名称: 文字 | 空值): 特性_;
    //@@{ 置命名项:setNamedItem, 特性_:Attr }
    置命名项(参数: 特性_): 特性_;
    //@@{ 置命名项NS:setNamedItemNS, 特性_:Attr }
    置命名项NS(参数: 特性_): 特性_;
    //@@{ 特性_:Attr }
    [索引: 数字]: 特性_;
...
接口 导航器_ 扩展 实例_, 导航器ID_, 导航器在线_, 导航器内容工具_, 导航器存储工具_, 导航定位_, MS导航器无轨道_, MS文件保存_, 导航信标_, 导航器并行硬件_, 导航用户媒体_ {
    ...
    //@@{ java启用:javaEnabled }
    java启用(): 真假;
    //@@{ ms发射URI:msLaunchUri, MS发射Uri回调:MSLaunchUriCallback }
    ms发射URI(uri: 文字, 成功回调?: MS发射Uri回调, 没有处理程序回调?: MS发射Uri回调): 无值;
    //@@{ 请求媒体键系统访问:requestMediaKeySystemAccess, 媒体键系统配置_:MediaKeySystemConfiguration, 预设_:Promise, 媒体键系统访问_:MediaKeySystemAccess }
...
接口 节点_ 扩展 事件目标_ {
    ...
    //@@{ 文本内容:textContent }
    文本内容: 文字 | 空值;
    //@@{ 附加子节点:appendChild, 节点_:Node }
    附加子节点<T 扩展 节点_>(新子: T): T;
    //@@{ 克隆节点:cloneNode, 节点_:Node }
    克隆节点(深度?: 真假): 节点_;
    //@@{ 比较文件位置:compareDocumentPosition, 节点_:Node }
    比较文件位置(其他: 节点_): 数字;
    //@@{ 包含:contains, 节点_:Node }
    包含(孩子: 节点_): 真假;
    //@@{ 有特性组:hasAttributes }
    有特性组(): 真假;
    //@@{ 有子节点:hasChildNodes }
    有子节点(): 真假;
    //@@{ 插入之前:insertBefore, 节点_:Node }
    插入之前<T 扩展 节点_>(新子: T, 参照子节点: 节点_ | 空值): T;
    //@@{ 是默认名称空间:isDefaultNamespace }
    是默认名称空间(名称空间URI: 文字 | 空值): 真假;
    //@@{ 是相等节点:isEqualNode, 节点_:Node }
    是相等节点(参数: 节点_): 真假;
    //@@{ 是相同节点:isSameNode, 节点_:Node }
    是相同节点(其他: 节点_): 真假;
    //@@{ 查找名称空间URI:lookupNamespaceURI }
    查找名称空间URI(前缀: 文字 | 空值): 文字 | 空值;
    //@@{ 查找前缀:lookupPrefix }
    查找前缀(名称空间URI: 文字 | 空值): 文字 | 空值;
    //@@{ 正常化:normalize }
    正常化(): 无值;
    //@@{ 删除子:removeChild, 节点_:Node }
    删除子<T 扩展 节点_>(旧子: T): T;
    //@@{ 替换子:replaceChild, 节点_:Node }
...
接口 通知_ 扩展 事件目标_ {
    ...
    //@@{ 关闭:close }
    关闭(): 无值;
    //@@{ 添加事件监听器:addEventListener, 通知事件映射_:NotificationEventMap, 通知_:Notification }
...
声明 值量 通知_: {
    ...
    原型: 通知_;
    //@@{ 通知选项_:NotificationOptions, 通知_:Notification }
    新建(标题: 文字, 选项?: 通知选项_): 通知_;
    //@@{ 请求许可:requestPermission, 通知允许回调_:NotificationPermissionCallback, 预设_:Promise, 通知许可_:NotificationPermission }
...
接口 离线音频背景_ 扩展 音频上下文基类_ {
    ...
    开始呈现(): 预设_<音频缓冲区_>;
    //@@{ 正在阻止:suspend, 预设_:Promise }
    正在阻止(阻止时间: 数字): 预设_<无值>;
    //@@{ 添加事件监听器:addEventListener, 离线音频上下文事件映射_:OfflineAudioContextEventMap, 离线音频背景_:OfflineAudioContext }
    添加事件监听器<K 扩展 键为 离线音频上下文事件映射_>(类型: K, 侦听器: (本体: 离线音频背景_, ev: 离线音频上下文事件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ 离线音频背景_:OfflineAudioContext }
声明 值量 离线音频背景_: {
...
接口 振荡器节点_ 扩展 音频节点_ {
    ...
    类型: 振荡器类型_;
    //@@{ 置周期波:setPeriodicWave, 周期波_:PeriodicWave }
    置周期波(周期波: 周期波_): 无值;
    //@@{ 开始:start }
    开始(当?: 数字): 无值;
    //@@{ 停止:stop }
    停止(当?: 数字): 无值;
    //@@{ 添加事件监听器:addEventListener, 振荡器节点事件映射_:OscillatorNodeEventMap, 振荡器节点_:OscillatorNode }
...
接口 付款请求_ 扩展 事件目标_ {
    ...
    显示(): 预设_<付款响应_>;
    //@@{ 添加事件监听器:addEventListener, 付款请求事件映射_:PaymentRequestEventMap, 付款请求_:PaymentRequest }
    添加事件监听器<K 扩展 键为 付款请求事件映射_>(类型: K, 侦听器: (本体: 付款请求_, ev: 付款请求事件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ 付款请求_:PaymentRequest }
声明 值量 付款请求_: {
    //@@{ 原型:prototype, 付款请求_:PaymentRequest }
    原型: 付款请求_;
    //@@{ 付款方法数据_:PaymentMethodData, 付款细节_:PaymentDetails, 付款选项_:PaymentOptions, 付款请求_:PaymentRequest }
...
//@@{ 付款请求更新事件_:PaymentRequestUpdateEvent }
声明 值量 付款请求更新事件_: {
    //@@{ 原型:prototype, 付款请求更新事件_:PaymentRequestUpdateEvent }
    原型: 付款请求更新事件_;
    //@@{ 付款请求更新事件初始化_:PaymentRequestUpdateEventInit, 付款请求更新事件_:PaymentRequestUpdateEvent }
...
接口 付款响应_ {
    ...
    //@@{ 送货选项:shippingOption }
    只读 送货选项: 文字 | 空值;
    //@@{ 完成:complete, 付款完成_:PaymentComplete, 预设_:Promise }
    完成(结果?: 付款完成_): 预设_<无值>;
    //@@{ 转为JSON:toJSON }
    转为JSON(): 任意;
...
接口 性能_ {
    ...
    //@@{ 现在:now }
    现在(): 数字;
    //@@{ 置资源计时缓冲大小:setResourceTimingBufferSize }
...
接口 性能小部件扩展_ {
    ...
    只读 性能计数器频率: 数字;
    //@@{ 添加事件监听器:addEventListener, 函数_:Function }
    添加事件监听器(事件类型: 文字, 回调: 函数_): 无值;
    //@@{ 取内存使用:getMemoryUsage }
    取内存使用(): 数字;
    //@@{ 取过程Cpu使用:getProcessCpuUsage }
    取过程Cpu使用(): 数字;
    //@@{ 取最近Cpu使用:getRecentCpuUsage }
    取最近Cpu使用(最后: 数字 | 空值): 任意;
    //@@{ 取最近帧:getRecentFrames }
    取最近帧(最后: 数字 | 空值): 任意;
    //@@{ 取最近内存使用:getRecentMemoryUsage }
    取最近内存使用(最后: 数字 | 空值): 任意;
    //@@{ 取最近绘制请求:getRecentPaintRequests }
    取最近绘制请求(最后: 数字 | 空值): 任意;
    //@@{ 删除事件监听器:removeEventListener, 函数_:Function }
...
接口 插件_ {
    ...
    //@@{ 版本:version }
    只读 版本: 文字;
    //@@{ 项目:item, Mime类型_:MimeType }
    项目(索引: 数字): Mime类型_;
    //@@{ 命名项目:namedItem, Mime类型_:MimeType }
    命名项目(类型: 文字): Mime类型_;
    //@@{ Mime类型_:MimeType }
    [索引: 数字]: Mime类型_;
...
声明 值量 指针事件_: {
    ...
    原型: 指针事件_;
    //@@{ 指针事件初始化_:PointerEventInit, 指针事件_:PointerEvent }
...
声明 值量 回退状态事件_: {
    ...
    原型: 回退状态事件;
    //@@{ 回退状态事件初始化_:PopStateEventInit, 回退状态事件:PopStateEvent }
...
声明 值量 进度事件_: {
    ...
    原型: 进度事件_;
    //@@{ 进度事件初始化_:ProgressEventInit, 进度事件_:ProgressEvent }
...
接口 压入管理器_ {
    ...
    取订阅(): 预设_<压入订阅_>;
    //@@{ 许可状态:permissionState, 压入订阅选项初始化_:PushSubscriptionOptionsInit, 预设_:Promise, 压入许可状态_:PushPermissionState }
    许可状态(选项?: 压入订阅选项初始化_): 预设_<压入许可状态_>;
    //@@{ 订阅:subscribe, 压入订阅选项初始化_:PushSubscriptionOptionsInit, 预设_:Promise, 压入订阅_:PushSubscription }
...
接口 压入订阅_ {
    ...
    只读 选项: 压入订阅选项_;
    //@@{ 取键:getKey, 压入加密键名称_:PushEncryptionKeyName, 数组缓冲区_:ArrayBuffer }
...
接口 范围_ {
    ...
    //@@{ 崩溃:collapse }
    崩溃(转为开始: 真假): 无值;
    //@@{ 比较边界点:compareBoundaryPoints, 范围_:Range }
    比较边界点(如何: 数字, 源范围: 范围_): 数字;
    //@@{ 创建上下文片段:createContextualFragment, 文档片段_:DocumentFragment }
    创建上下文片段(片段: 文字): 文档片段_;
    //@@{ 删除内容:deleteContents }
    删除内容(): 无值;
    //@@{ 分离:detach }
    分离(): 无值;
    //@@{ 扩大:expand, 扩大粒度_:ExpandGranularity }
    扩大(单位_: 扩大粒度_): 真假;
    ...
    //@@{ 取客户矩形组:getClientRects, 客户矩形列表_:ClientRectList }
    取客户矩形组(): 客户矩形列表_;
    //@@{ 插入节点:insertNode, 节点_:Node }
    插入节点(新节点: 节点_): 无值;
    //@@{ 选择节点:selectNode, 节点_:Node }
    选择节点(引用节点: 节点_): 无值;
    //@@{ 选择节点内容:selectNodeContents, 节点_:Node }
    选择节点内容(引用节点: 节点_): 无值;
    //@@{ 置结束:setEnd, 节点_:Node }
    置结束(引用节点: 节点_, 偏移: 数字): 无值;
    //@@{ 置结束后:setEndAfter, 节点_:Node }
    置结束后(引用节点: 节点_): 无值;
    //@@{ 置结束之前:setEndBefore, 节点_:Node }
    置结束之前(引用节点: 节点_): 无值;
    //@@{ 置开始:setStart, 节点_:Node }
    置开始(引用节点: 节点_, 偏移: 数字): 无值;
    //@@{ 置开始后:setStartAfter, 节点_:Node }
    置开始后(引用节点: 节点_): 无值;
    //@@{ 置开始之前:setStartBefore, 节点_:Node }
    置开始之前(引用节点: 节点_): 无值;
    //@@{ 围绕内容:surroundContents, 节点_:Node }
    围绕内容(新父: 节点_): 无值;
    //@@{ 转为文字:toString }
    转为文字(): 文字;
...
声明 值量 请求_: { 
    ...
    原型: 请求_;
    //@@{ 请求_:Request, 请求初始化_:RequestInit }
...
声明 值量 响应_: {
    ...
    原型: 响应_;
    //@@{ 响应初始化_:ResponseInit, 响应_:Response }
    新建(体?: 任意, 初始化?: 响应初始化_): 响应_;
    //@@{ 错误:error, 响应_:Response }
    错误: () => 响应_;
    //@@{ 重定向:redirect, 响应_:Response }
...
接口 RTCDtls传输_ 扩展 RTC统计数据提供者_ {
    ...
    取远程参数(): RTCDtls参数_ | 空值;
    //@@{ 开始:start, RTCDtls参数_:RTCDtlsParameters }
    开始(远程参数: RTCDtls参数_): 无值;
    //@@{ 停止:stop }
    停止(): 无值;
    //@@{ 添加事件监听器:addEventListener, RTCDtls传输事件映射_:RTCDtlsTransportEventMap, RTCDtls传输_:RTCDtlsTransport }
    添加事件监听器<K 扩展 键为 RTCDtls传输事件映射_>(类型: K, 侦听器: (本体: RTCDtls传输_, ev: RTCDtls传输事件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ RTCDtls传输_:RTCDtlsTransport }
声明 值量 RTCDtls传输_: {
    //@@{ 原型:prototype, RTCDtls传输_:RTCDtlsTransport }
    原型: RTCDtls传输_;
    //@@{ RTCIce传输_:RTCIceTransport, RTCDtls传输_:RTCDtlsTransport }
...
接口 RTCDtmf发送事件映射_ {
    //@@{ RTCDTMF声调改变事件_:RTCDTMFToneChangeEvent }
    "声调改变": RTCDTMF声调改变事件_;
...
接口 RTCDtmf发送_ 扩展 事件目标_ {
    ...
    //@@{ 添加事件监听器:addEventListener, RTCDtmf发送事件映射_:RTCDtmfSenderEventMap, RTCDtmf发送_:RTCDtmfSender }
    添加事件监听器<K 扩展 键为 RTCDtmf发送事件映射_>(类型: K, 侦听器: (本体: RTCDtmf发送_, ev: RTCDtmf发送事件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ RTCDtmf发送_:RTCDtmfSender }
声明 值量 RTCDtmf发送_: {
    //@@{ 原型:prototype, RTCDtmf发送_:RTCDtmfSender }
    原型: RTCDtmf发送_;
    //@@{ RTCRtp发送方:RTCRtpSender, RTCDtmf发送_:RTCDtmfSender }
...
声明 值量 RTCDTMF声调改变事件_: {
    ...
    原型: RTCDTMF声调改变事件_;
    //@@{ RTCDTMF音调改变事件初始化_:RTCDTMFToneChangeEventInit, RTCDTMF声调改变事件_:RTCDTMFToneChangeEvent }
...
声明 值量 RTCIce候选_: {
    ...
    原型: RTCIce候选;
    //@@{ RTCICE候选初始化_:RTCIceCandidateInit, RTCIce候选:RTCIceCandidate }
...
接口 RTCIce采集者_ 扩展 RTC统计数据提供者_ {
    ...
    取本地参数(): RTCICE参数_;
    //@@{ 添加事件监听器:addEventListener, RTCIce采集者事件件映射_:RTCIceGathererEventMap, RTCIce采集者_:RTCIceGatherer }
    添加事件监听器<K 扩展 键为 RTCIce采集者事件件映射_>(类型: K, 侦听器: (本体: RTCIce采集者_, ev: RTCIce采集者事件件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ RTCIce采集者_:RTCIceGatherer }
声明 值量 RTCIce采集者_: {
    //@@{ 原型:prototype, RTCIce采集者_:RTCIceGatherer }
    原型: RTCIce采集者_;
    //@@{ RTCICE收集选项_:RTCIceGatherOptions, RTCIce采集者_:RTCIceGatherer }
...
接口 RTCIce传输_ 扩展 RTC统计数据提供者_ {
    ...
    只读 状态: RTCIce传输状态_;
    //@@{ 添加远程候选:addRemoteCandidate, RTCICE候选字典_:RTCIceCandidateDictionary, RTCICE候选完整性_:RTCIceCandidateComplete }
    ...
    取远程参数(): RTCICE参数_ | 空值;
    //@@{ 置远程候选:setRemoteCandidates, RTCICE候选字典_:RTCIceCandidateDictionary }
    置远程候选(远程候选: RTCICE候选字典_[]): 无值;
    //@@{ 开始:start, RTCIce采集者_:RTCIceGatherer, RTCICE参数_:RTCIceParameters, RTCIce角色_:RTCIceRole }
    开始(采集者: RTCIce采集者_, 远程参数: RTCICE参数_, 角色?: RTCIce角色_): 无值;
    //@@{ 停止:stop }
    停止(): 无值;
    //@@{ 添加事件监听器:addEventListener, RTCIce传输事件映射_:RTCIceTransportEventMap, RTCIce传输_:RTCIceTransport }
...
接口 RTC对等连接事件映射_ {
    //@@{ 媒体流事件_:MediaStreamEvent }
    "添加流": 媒体流事件_;
    //@@{ RTC对等连接Ice事件_:RTCPeerConnectionIceEvent }
    "ice候选": RTC对等连接Ice事件_;
    //@@{ 事件_:Event }
    "ice连接状态变化": 事件_;
    //@@{ 事件_:Event }
...
接口 RTC对等连接_ 扩展 事件目标_ {
    ...
    只读 信号状态: RTC信号状态_;
    //@@{ 添加Ice候选:addIceCandidate, RTCIce候选:RTCIceCandidate, 无效的函数_:VoidFunction, RTC对等连接错误回调_:RTCPeerConnectionErrorCallback, 预设_:Promise }
    添加Ice候选(候选: RTCIce候选, 成功回调?: 无效的函数_, 失败回调?: RTC对等连接错误回调_): 预设_<无值>;
    //@@{ 添加流:addStream, 媒体流_:MediaStream }
    添加流(流: 媒体流_): 无值;
    //@@{ 关闭:close }
    关闭(): 无值;
    //@@{ 创建答案:createAnswer, RTC会话描述回调_:RTCSessionDescriptionCallback, RTC对等连接错误回调_:RTCPeerConnectionErrorCallback, 预设_:Promise, RTC会话描述_:RTCSessionDescription }
    创建答案(成功回调?: RTC会话描述回调_, 失败回调?: RTC对等连接错误回调_): 预设_<RTC会话描述_>;
    //@@{ 创建提供:createOffer, RTC会话描述回调_:RTCSessionDescriptionCallback, RTC对等连接错误回调_:RTCPeerConnectionErrorCallback, RTC提供选项_:RTCOfferOptions, 预设_:Promise, RTC会话描述_:RTCSessionDescription }
    ...
    取远程流(): 媒体流_[];
    //@@{ 取统计数据:getStats, 媒体流轨道_:MediaStreamTrack, RTC统计数据回调_:RTCStatsCallback, RTC对等连接错误回调_:RTCPeerConnectionErrorCallback, 预设_:Promise, RTC统计报告_:RTCStatsReport }
    取统计数据(选择: 媒体流轨道_ | 空值, 成功回调?: RTC统计数据回调_, 失败回调?: RTC对等连接错误回调_): 预设_<RTC统计报告_>;
    //@@{ 取流按Id:getStreamById, 媒体流_:MediaStream }
    取流按Id(流Id: 文字): 媒体流_ | 空值;
    //@@{ 删除流:removeStream, 媒体流_:MediaStream }
    删除流(流: 媒体流_): 无值;
    //@@{ 置本地描述:setLocalDescription, RTC会话描述_:RTCSessionDescription, 无效的函数_:VoidFunction, RTC对等连接错误回调_:RTCPeerConnectionErrorCallback, 预设_:Promise }
    置本地描述(描述: RTC会话描述_, 成功回调?: 无效的函数_, 失败回调?: RTC对等连接错误回调_): 预设_<无值>;
    //@@{ 置远程描述:setRemoteDescription, RTC会话描述_:RTCSessionDescription, 无效的函数_:VoidFunction, RTC对等连接错误回调_:RTCPeerConnectionErrorCallback, 预设_:Promise }
    置远程描述(描述: RTC会话描述_, 成功回调?: 无效的函数_, 失败回调?: RTC对等连接错误回调_): 预设_<无值>;
    //@@{ 添加事件监听器:addEventListener, RTC对等连接事件映射_:RTCPeerConnectionEventMap, RTC对等连接_:RTCPeerConnection }
    添加事件监听器<K 扩展 键为 RTC对等连接事件映射_>(类型: K, 侦听器: (本体: RTC对等连接_, ev: RTC对等连接事件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ RTC对等连接_:RTCPeerConnection }
声明 值量 RTC对等连接_: {
    //@@{ 原型:prototype, RTC对等连接_:RTCPeerConnection }
    原型: RTC对等连接_;
    //@@{ RTC配置_:RTCConfiguration, RTC对等连接_:RTCPeerConnection }
...
声明 值量 RTC对等连接冰事件_: {
    ...
    原型: RTC对等连接Ice事件_;
    //@@{ RTC对等连接ICE事件初始化_:RTCPeerConnectionIceEventInit, RTC对等连接Ice事件_:RTCPeerConnectionIceEvent }
...
接口 RTCRtp接收机_ 扩展 RTC统计数据提供者_ {
    ...
    取贡献来源(): RTCRtp贡献源_[];
    //@@{ 收到:receive, RTCRtp参数_:RTCRtpParameters }
    收到(参数: RTCRtp参数_): 无值;
    //@@{ 请求发送CSRC:requestSendCSRC }
    请求发送CSRC(csrc: 数字): 无值;
    //@@{ 置传输:setTransport, RTCDtls传输_:RTCDtlsTransport, RTCSrtpsd传输_:RTCSrtpSdesTransport }
    置传输(传输: RTCDtls传输_ | RTCSrtpsd传输_, rtcp传输?: RTCDtls传输_): 无值;
    //@@{ 停止:stop }
    停止(): 无值;
    //@@{ 添加事件监听器:addEventListener, RTCRtp接收机事件映射_:RTCRtpReceiverEventMap, RTCRtp接收机_:RTCRtpReceiver }
    添加事件监听器<K 扩展 键为 RTCRtp接收机事件映射_>(类型: K, 侦听器: (本体: RTCRtp接收机_, ev: RTCRtp接收机事件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ RTCRtp接收机_:RTCRtpReceiver }
声明 值量 RTCRtp接收机_: {
    //@@{ 原型:prototype, RTCRtp接收机_:RTCRtpReceiver }
    原型: RTCRtp接收机_;
    //@@{ RTCDtls传输_:RTCDtlsTransport, RTCSrtpsd传输_:RTCSrtpSdesTransport, RTCRtp接收机_:RTCRtpReceiver }
    新建(传输: RTCDtls传输_ | RTCSrtpsd传输_, 种类: 文字, rtcp传输?: RTCDtls传输_): RTCRtp接收机_;
    //@@{ 取功能:getCapabilities, RTCRtp功能_:RTCRtpCapabilities }
    取功能(种类?: 文字): RTCRtp功能_;
...
接口 RTCRtp发送方 扩展 RTC统计数据提供者_ {
    ...
    //@@{ 传输:transport, RTCDtls传输_:RTCDtlsTransport, RTCSrtpsd传输_:RTCSrtpSdesTransport }
    只读 传输: RTCDtls传输_ | RTCSrtpsd传输_;
    //@@{ 发送:send, RTCRtp参数_:RTCRtpParameters }
    发送(参数: RTCRtp参数_): 无值;
    //@@{ 置轨道:setTrack, 媒体流轨道_:MediaStreamTrack }
    置轨道(轨道: 媒体流轨道_): 无值;
    //@@{ 置传输:setTransport, RTCDtls传输_:RTCDtlsTransport, RTCSrtpsd传输_:RTCSrtpSdesTransport }
    置传输(传输: RTCDtls传输_ | RTCSrtpsd传输_, rtcp传输?: RTCDtls传输_): 无值;
    //@@{ 停止:stop }
    停止(): 无值;
    //@@{ 添加事件监听器:addEventListener, RTCRtp发送事件映射_:RTCRtpSenderEventMap, RTCRtp发送方:RTCRtpSender }
...
声明 值量 RTCRtp发送方_: {
    ...
    原型: RTCRtp发送方;
    //@@{ 媒体流轨道_:MediaStreamTrack, RTCDtls传输_:RTCDtlsTransport, RTCSrtpsd传输_:RTCSrtpSdesTransport, RTCRtp发送方:RTCRtpSender }
...
声明 值量 RTC会话描述_: {
    ...
    原型: RTC会话描述_;
    //@@{ RTC会话描述初始化_:RTCSessionDescriptionInit, RTC会话描述_:RTCSessionDescription }
...
接口 RTCSrtpsd传输_ 扩展 事件目标_ {
    ...
    //@@{ 传输:transport, RTCIce传输_:RTCIceTransport }
    只读 传输: RTCIce传输_;
    //@@{ 添加事件监听器:addEventListener, RTCSrtpSdes传输事件映射_:RTCSrtpSdesTransportEventMap, RTCSrtpsd传输_:RTCSrtpSdesTransport }
    添加事件监听器<K 扩展 键为 RTCSrtpSdes传输事件映射_>(类型: K, 侦听器: (本体: RTCSrtpsd传输_, ev: RTCSrtpSdes传输事件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ RTCSrtpsd传输_:RTCSrtpSdesTransport }
声明 值量 RTCSrtpsd传输_: {
    //@@{ 原型:prototype, RTCSrtpsd传输_:RTCSrtpSdesTransport }
    原型: RTCSrtpsd传输_;
    //@@{ RTCIce传输_:RTCIceTransport, RTCSrtpsd参数_:RTCSrtpSdesParameters, RTCSrtpsd传输_:RTCSrtpSdesTransport }
...
接口 屏幕_ 扩展 事件目标_ {
    ...
    //@@{ 宽度:width }
    只读 宽度: 数字;
    //@@{ ms锁方向:msLockOrientation }
    ms锁方向(方向: 文字 | 文字[]): 真假;
    //@@{ ms解锁方向:msUnlockOrientation }
    ms解锁方向(): 无值;
    //@@{ 添加事件监听器:addEventListener, 屏幕事件映射_:ScreenEventMap, 屏幕_:Screen }
...
接口 脚本处理器节点_ 扩展 音频节点_ {
    ...
    //@@{ 添加事件监听器:addEventListener, 脚本处理器节点事件映射_:ScriptProcessorNodeEventMap, 脚本处理器节点_:ScriptProcessorNode }
...
接口 服务工人_ 扩展 事件目标_, 抽象的工人_ {
    ...
    //@@{ 发布消息:postMessage }
    发布消息(消息: 任意, 转移?: 任意[]): 无值;
    //@@{ 添加事件监听器:addEventListener, 服务工人事件映射_:ServiceWorkerEventMap, 服务工人_:ServiceWorker }
...
接口 服务人员容器事件映射_ {
    //@@{ 事件_:Event }
    "控制器改变": 事件_;
    //@@{ 服务工人消息事件_:ServiceWorkerMessageEvent }
    "消息": 服务工人消息事件_;
...
接口 服务工人容器_ 扩展 事件目标_ {
    ...
    取注册组(): 预设_<服务人员注册_[]>;
    //@@{ 注册:register, USV字符串:USVString, 注册选项_:RegistrationOptions, 预设_:Promise, 服务人员注册_:ServiceWorkerRegistration }
    注册(脚本URL: USV字符串, 选项?: 注册选项_): 预设_<服务人员注册_>;
    //@@{ 添加事件监听器:addEventListener, 服务人员容器事件映射_:ServiceWorkerContainerEventMap, 服务工人容器_:ServiceWorkerContainer }
...
声明 值量 服务工人消息事件_: {
    ...
    原型: 服务工人消息事件_;
    //@@{ 服务工人消息事件初始化_:ServiceWorkerMessageEventInit, 服务工人消息事件_:ServiceWorkerMessageEvent }
...
接口 服务人员注册_ 扩展 事件目标_ {
    ...
    只读 等待: 服务工人_ | 空值;
    //@@{ 取通知:getNotifications, 取通知选项_:GetNotificationOptions, 预设_:Promise, 通知_:Notification }
    取通知(过滤器?: 取通知选项_): 预设_<通知_[]>;
    //@@{ 显示通知:showNotification, 通知选项_:NotificationOptions, 预设_:Promise }
    显示通知(标题: 文字, 选项?: 通知选项_): 预设_<无值>;
    //@@{ 注销:unregister, 预设_:Promise }
    注销(): 预设_<真假>;
    //@@{ 更新:update, 预设_:Promise }
    更新(): 预设_<无值>;
    //@@{ 添加事件监听器:addEventListener, 服务人员注册事件映射_:ServiceWorkerRegistrationEventMap, 服务人员注册_:ServiceWorkerRegistration }
...
接口 源缓冲区_ 扩展 事件目标_ {
    ...
    //@@{ 终止:abort }
    终止(): 无值;
    //@@{ 附加缓冲:appendBuffer, 数组缓冲区_:ArrayBuffer, 数组缓冲区视图_:ArrayBufferView }
    附加缓冲(数据: 数组缓冲区_ | 数组缓冲区视图_): 无值;
    //@@{ 附加流:appendStream, MS流_:MSStream }
...
接口 语音合成_ 扩展 事件目标_ {
    ...
    //@@{ 继续:resume }
    继续(): 无值;
    //@@{ 说话:speak, 语音合成话语_:SpeechSynthesisUtterance }
    说话(话语: 语音合成话语_): 无值;
    //@@{ 添加事件监听器:addEventListener, 语音合成事件映射_:SpeechSynthesisEventMap, 语音合成_:SpeechSynthesis }
...
//@@{ 语音合成事件_:SpeechSynthesisEvent }
声明 值量 语音合成事件_: {
    //@@{ 原型:prototype, 语音合成事件_:SpeechSynthesisEvent }
    原型: 语音合成事件_;
    //@@{ 语音合成事件初始化_:SpeechSynthesisEventInit, 语音合成事件_:SpeechSynthesisEvent }
...
接口 语音合成话语_ 扩展 事件目标_ {
    ...
    //@@{ 音量:volume }
    音量: 数字;
    //@@{ 添加事件监听器:addEventListener, 语音合成话语事件映射_:SpeechSynthesisUtteranceEventMap, 语音合成话语_:SpeechSynthesisUtterance }
    添加事件监听器<K 扩展 键为 语音合成话语事件映射_>(类型: K, 侦听器: (本体: 语音合成话语_, ev: 语音合成话语事件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ 语音合成话语_:SpeechSynthesisUtterance }
声明 值量 语音合成话语_: {
...
声明 值量 存储事件_: {
    ...
    原型: 存储事件_;
    //@@{ 存储事件初始化_:StorageEventInit, 存储事件_:StorageEvent }
...
//@@{ 加密原语_:SubtleCrypto }
接口 加密原语_ {
    //@@{ 解密:decrypt, RsaOaep参数_:RsaOaepParams, AesCtr参数_:AesCtrParams, AesCbc参数_:AesCbcParams, AesCmac参数组_:AesCmacParams, AesGcm参数_:AesGcmParams, AesCbf参数组_:AesCfbParams, 加密密钥_:CryptoKey, 缓冲源_:BufferSource, 预设等_:PromiseLike, 数组缓冲区_:ArrayBuffer }
    解密(算法: 文字 | RsaOaep参数_ | AesCtr参数_ | AesCbc参数_ | AesCmac参数组_ | AesGcm参数_ | AesCbf参数组_, 键: 加密密钥_, 数据: 缓冲源_): 预设等_<数组缓冲区_>;
    //@@{ 推导位:deriveBits, Ecdh键推导出参数组_:EcdhKeyDeriveParams, Dh键获得参数_:DhKeyDeriveParams, 合并参数_:ConcatParams, HkdfCtr参数_:HkdfCtrParams, Pbkdf2参数_:Pbkdf2Params, 加密密钥_:CryptoKey, 预设等_:PromiseLike, 数组缓冲区_:ArrayBuffer }
    推导位(算法: 文字 | Ecdh键推导出参数组_ | Dh键获得参数_ | 合并参数_ | HkdfCtr参数_ | Pbkdf2参数_, 基键: 加密密钥_, 长度: 数字): 预设等_<数组缓冲区_>;
    //@@{ 推导键:deriveKey, Ecdh键推导出参数组_:EcdhKeyDeriveParams, Dh键获得参数_:DhKeyDeriveParams, 合并参数_:ConcatParams, HkdfCtr参数_:HkdfCtrParams, Pbkdf2参数_:Pbkdf2Params, 加密密钥_:CryptoKey, Aes派生的键参数组_:AesDerivedKeyParams, Hmac进口参数_:HmacImportParams, 预设等_:PromiseLike }
    ...
    //@@{ 消化:digest, 算法标识符_:AlgorithmIdentifier, 缓冲源_:BufferSource, 预设等_:PromiseLike, 数组缓冲区_:ArrayBuffer }
    消化(算法: 算法标识符_, 数据: 缓冲源_): 预设等_<数组缓冲区_>;
    //@@{ 加密:encrypt, RsaOaep参数_:RsaOaepParams, AesCtr参数_:AesCtrParams, AesCbc参数_:AesCbcParams, AesCmac参数组_:AesCmacParams, AesGcm参数_:AesGcmParams, AesCbf参数组_:AesCfbParams, 加密密钥_:CryptoKey, 缓冲源_:BufferSource, 预设等_:PromiseLike, 数组缓冲区_:ArrayBuffer }
    加密(算法: 文字 | RsaOaep参数_ | AesCtr参数_ | AesCbc参数_ | AesCmac参数组_ | AesGcm参数_ | AesCbf参数组_, 键: 加密密钥_, 数据: 缓冲源_): 预设等_<数组缓冲区_>;
    //@@{ 出口键:exportKey, 加密密钥_:CryptoKey, 预设等_:PromiseLike, Json网络键_:JsonWebKey }
    出口键(格式: "jwk", 键: 加密密钥_): 预设等_<Json网络键_>;
    //@@{ 出口键:exportKey, 加密密钥_:CryptoKey, 预设等_:PromiseLike, 数组缓冲区_:ArrayBuffer }
    出口键(格式: "raw" | "pkcs8" | "spki", 键: 加密密钥_): 预设等_<数组缓冲区_>;
    //@@{ 出口键:exportKey, 加密密钥_:CryptoKey, 预设等_:PromiseLike, Json网络键_:JsonWebKey, 数组缓冲区_:ArrayBuffer }
    出口键(格式: 文字, 键: 加密密钥_): 预设等_<Json网络键_ | 数组缓冲区_>;
    //@@{ 生成密钥:generateKey, 预设等_:PromiseLike, 加密密钥对_:CryptoKeyPair, 加密密钥_:CryptoKey }
    生成密钥(算法: 文字, 可推断出的: 真假, 键用法: 文字[]): 预设等_<加密密钥对_ | 加密密钥_>;
    //@@{ 生成密钥:generateKey, Rsa哈希键创参数组_:RsaHashedKeyGenParams, Ec键创参数个数_:EcKeyGenParams, DH键创参数组_:DhKeyGenParams, 预设等_:PromiseLike, 加密密钥对_:CryptoKeyPair }
    生成密钥(算法: Rsa哈希键创参数组_ | Ec键创参数个数_ | DH键创参数组_, 可推断出的: 真假, 键用法: 文字[]): 预设等_<加密密钥对_>;
    //@@{ 生成密钥:generateKey, Aes键创参数组_:AesKeyGenParams, Hmac键创参数组_:HmacKeyGenParams, Pbkdf2参数_:Pbkdf2Params, 预设等_:PromiseLike, 加密密钥_:CryptoKey }
    生成密钥(算法: Aes键创参数组_ | Hmac键创参数组_ | Pbkdf2参数_, 可推断出的: 真假, 键用法: 文字[]): 预设等_<加密密钥_>;
    //@@{ 导入键:importKey, Json网络键_:JsonWebKey, Rsa散列导入参数_:RsaHashedImportParams, EC键进口参数组_:EcKeyImportParams, Hmac进口参数_:HmacImportParams, Dh进口键参数_:DhImportKeyParams, 预设等_:PromiseLike, 加密密钥_:CryptoKey }
    导入键(格式: "jwk", 键数据: Json网络键_, 算法: 文字 | Rsa散列导入参数_ | EC键进口参数组_ | Hmac进口参数_ | Dh进口键参数_, 可推断出的: 真假, 键用法: 文字[]): 预设等_<加密密钥_>;
    //@@{ 导入键:importKey, 缓冲源_:BufferSource, Rsa散列导入参数_:RsaHashedImportParams, EC键进口参数组_:EcKeyImportParams, Hmac进口参数_:HmacImportParams, Dh进口键参数_:DhImportKeyParams, 预设等_:PromiseLike, 加密密钥_:CryptoKey }
    导入键(格式: "raw" | "pkcs8" | "spki", 键数据: 缓冲源_, 算法: 文字 | Rsa散列导入参数_ | EC键进口参数组_ | Hmac进口参数_ | Dh进口键参数_, 可推断出的: 真假, 键用法: 文字[]): 预设等_<加密密钥_>;
    //@@{ 导入键:importKey, Json网络键_:JsonWebKey, 缓冲源_:BufferSource, Rsa散列导入参数_:RsaHashedImportParams, EC键进口参数组_:EcKeyImportParams, Hmac进口参数_:HmacImportParams, Dh进口键参数_:DhImportKeyParams, 预设等_:PromiseLike, 加密密钥_:CryptoKey }
    导入键(格式: 文字, 键数据: Json网络键_ | 缓冲源_, 算法: 文字 | Rsa散列导入参数_ | EC键进口参数组_ | Hmac进口参数_ | Dh进口键参数_, 可推断出的: 真假, 键用法: 文字[]): 预设等_<加密密钥_>;
    //@@{ 标志:sign, RsaPss参数_:RsaPssParams, Ecdsa参数_:EcdsaParams, AesCmac参数组_:AesCmacParams, 加密密钥_:CryptoKey, 缓冲源_:BufferSource, 预设等_:PromiseLike, 数组缓冲区_:ArrayBuffer }
    标志(算法: 文字 | RsaPss参数_ | Ecdsa参数_ | AesCmac参数组_, 键: 加密密钥_, 数据: 缓冲源_): 预设等_<数组缓冲区_>;
    //@@{ 打开钥匙:unwrapKey, 缓冲源_:BufferSource, 加密密钥_:CryptoKey, 算法标识符_:AlgorithmIdentifier, 预设等_:PromiseLike }
    打开钥匙(格式: 文字, 包装键: 缓冲源_, 要打开的钥匙: 加密密钥_, 打开算法: 算法标识符_, 打开键算法: 算法标识符_, 可推断出的: 真假, 键用法: 文字[]): 预设等_<加密密钥_>;
    //@@{ 验证:verify, RsaPss参数_:RsaPssParams, Ecdsa参数_:EcdsaParams, AesCmac参数组_:AesCmacParams, 加密密钥_:CryptoKey, 缓冲源_:BufferSource, 预设等_:PromiseLike }
    验证(算法: 文字 | RsaPss参数_ | Ecdsa参数_ | AesCmac参数组_, 键: 加密密钥_, 签名: 缓冲源_, 数据: 缓冲源_): 预设等_<真假>;
    //@@{ 包装键:wrapKey, 加密密钥_:CryptoKey, 算法标识符_:AlgorithmIdentifier, 预设等_:PromiseLike, 数组缓冲区_:ArrayBuffer }
...
接口 SVG超链接元素_ 扩展 SVG图形元素_, SVGURI参考_ {
    ...
    只读 目标: SVG动画文字_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG超链接元素_:SVGAElement }
...
接口 SVG角_ {
    ...
    值在指定单位: 数字;
    //@@{ 转换为指定的单位:convertToSpecifiedUnits }
    转换为指定的单位(单位类型: 数字): 无值;
    //@@{ 新值指定的单位:newValueSpecifiedUnits }
...
接口 SVG圆元素_ 扩展 SVG图形元素_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 r: SVG动画长度_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG圆元素_:SVGCircleElement }
...
接口 SVG剪切路径元素_ 扩展 SVG图形元素_, SVG单位类型_ {
    ...
    只读 剪切路径单位: SVG动画枚举_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG剪切路径元素_:SVGClipPathElement }
...
接口 SVG组件传递函数元素_ 扩展 SVG元素_ {
    ...
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG组件传递函数元素_:SVGComponentTransferFunctionElement }
...
接口 SVG预定元素 扩展 SVG图形元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG预定元素:SVGDefsElement }
...
接口 SVG纯文本元素_ 扩展 SVG元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG纯文本元素_:SVGDescElement }
...
接口 SVG元素_ 扩展 元素_ {
    ...
    //@@{ xml基:xmlbase }
    xml基: 文字;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG元素_:SVGElement }
...
接口 SVG元素实例列表_ {
    //@@{ 长度:length }
    只读 长度: 数字;
    //@@{ 项目:item, SVG元素实例_:SVGElementInstance }
    项目(索引: 数字): SVG元素实例_;
...
接口 SVG椭圆元素_ 扩展 SVG图形元素_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 ry: SVG动画长度_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG椭圆元素_:SVGEllipseElement }
...
接口 SVG滤镜混合元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    ...
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜混合元素_:SVGFEBlendElement }
...
接口 SVG滤镜颜色矩阵元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    ...
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜颜色矩阵元素_:SVGFEColorMatrixElement }
...
接口 SVG滤镜组件转移元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    //@@{ SVG动画文字_:SVGAnimatedString }
    只读 in1: SVG动画文字_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜组件转移元素_:SVGFEComponentTransferElement }
...
接口 SVG滤镜复合元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    ...
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜复合元素_:SVGFECompositeElement }
...
接口 SVG滤镜扩散灯光元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    ...
    只读 表面规模: SVG动画数字_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜扩散灯光元素_:SVGFEDiffuseLightingElement }
...
接口 SVG滤镜位移映射元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    ...
    只读 __SVG_通道_未知__: 数字;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜位移映射元素_:SVGFEDisplacementMapElement }
...
接口 SVGFE漫反射灯光元素_ 扩展 SVG元素_ {
    ...
    只读 海拔高度: SVG动画数字_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVGFE漫反射灯光元素_:SVGFEDistantLightElement }
...
接口 SVG滤镜洪水元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜洪水元素_:SVGFEFloodElement }
...
接口 SVG滤镜透明函数元素_ 扩展 SVG组件传递函数元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜透明函数元素_:SVGFEFuncAElement }
...
接口 SVG滤镜蓝函数元素_ 扩展 SVG组件传递函数元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜蓝函数元素_:SVGFEFuncBElement }
...
接口 SVG滤镜绿函数元素_ 扩展 SVG组件传递函数元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜绿函数元素_:SVGFEFuncGElement }
...
接口 SVG滤镜红函数元素_ 扩展 SVG组件传递函数元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜红函数元素_:SVGFEFuncRElement }
...
接口 SVG滤镜高斯模糊元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    ...
    只读 标准偏差Y: SVG动画数字_;
    //@@{ 设置标准偏差:setStdDeviation }
    设置标准偏差(标准偏差X: 数字, 标准偏差Y: 数字): 无值;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜高斯模糊元素_:SVGFEGaussianBlurElement }
...
接口 SVG滤镜图像元素_ 扩展 SVG元素_, SVG过滤原始标准特性_, SVGURI参考_ {
    ...
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜图像元素_:SVGFEImageElement }
...
接口 SVG滤镜合并元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜合并元素_:SVGFEMergeElement }
...
接口 SVG滤镜合并节点元素_ 扩展 SVG元素_ {
    //@@{ SVG动画文字_:SVGAnimatedString }
    只读 in1: SVG动画文字_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜合并节点元素_:SVGFEMergeNodeElement }
...
接口 SVG滤镜形态元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    ...
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜形态元素_:SVGFEMorphologyElement }
...
接口 SVG滤镜偏移元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    ...
    //@@{ SVG动画文字_:SVGAnimatedString }
    只读 in1: SVG动画文字_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜偏移元素_:SVGFEOffsetElement }
...
接口 SVG滤镜点灯光元素_ 扩展 SVG元素_ {
    ...
    //@@{ SVG动画数字_:SVGAnimatedNumber }
    只读 z: SVG动画数字_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜点灯光元素_:SVGFEPointLightElement }
...
接口 SVG滤镜镜面灯光元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    ...
    //@@{ 表面规模:surfaceScale, SVG动画数字_:SVGAnimatedNumber }
    只读 表面规模: SVG动画数字_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜镜面灯光元素_:SVGFESpecularLightingElement }
...
接口 SVG滤镜聚灯光元素_ 扩展 SVG元素_ {
    ...
    //@@{ SVG动画数字_:SVGAnimatedNumber }
    只读 z: SVG动画数字_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜聚灯光元素_:SVGFESpotLightElement }
...
接口 SVG滤镜瓷砖元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    //@@{ SVG动画文字_:SVGAnimatedString }
    只读 in1: SVG动画文字_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜瓷砖元素_:SVGFETileElement }
...
接口 SVG滤镜动荡元素_ 扩展 SVG元素_, SVG过滤原始标准特性_ {
    ...
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG滤镜动荡元素_:SVGFETurbulenceElement }
...
接口 SVG过滤器元素_ 扩展 SVG元素_, SVG单位类型_, SVGURI参考_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 y: SVG动画长度_;
    //@@{ 置过滤器Res:setFilterRes }
    置过滤器Res(过滤器ResX: 数字, 过滤器ResY: 数字): 无值;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG过滤器元素_:SVGFilterElement }
...
接口 SVG外部对象元素_ 扩展 SVG图形元素_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 y: SVG动画长度_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG外部对象元素_:SVGForeignObjectElement }
...
接口 SVG组元素_ 扩展 SVG图形元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG组元素_:SVGGElement }
...
接口 SVG渐变元素_ 扩展 SVG元素_, SVG单位类型_, SVGURI参考_ {
    ...
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG渐变元素_:SVGGradientElement }
...
接口 SVG图形元素_ 扩展 SVG元素_, SVG测试_ {
    ...
    取屏幕CTM(): SVG矩阵_;
    //@@{ 取变换从元素:getTransformToElement, SVG元素_:SVGElement, SVG矩阵_:SVGMatrix }
    取变换从元素(元素: SVG元素_): SVG矩阵_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG图形元素_:SVGGraphicsElement }
...
接口 SVG图像元素_ 扩展 SVG图形元素_, SVGURI参考_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 y: SVG动画长度_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG图像元素_:SVGImageElement }
...
接口 SVG长度列表_ {
    //@@{ 条目数量:numberOfItems }
    只读 条目数量: 数字;
    //@@{ 附加项目:appendItem, SVG长度_:SVGLength }
    附加项目(新项目: SVG长度_): SVG长度_;
    //@@{ 清除:clear }
    清除(): 无值;
    //@@{ 取项目:getItem, SVG长度_:SVGLength }
    取项目(索引: 数字): SVG长度_;
    //@@{ 初始化:initialize, SVG长度_:SVGLength }
    初始化(新项目: SVG长度_): SVG长度_;
    //@@{ 插入项目之前:insertItemBefore, SVG长度_:SVGLength }
    插入项目之前(新项目: SVG长度_, 索引: 数字): SVG长度_;
    //@@{ 删除项目:removeItem, SVG长度_:SVGLength }
    删除项目(索引: 数字): SVG长度_;
    //@@{ 替换项目:replaceItem, SVG长度_:SVGLength }
...
接口 SVG线性渐变元素_ 扩展 SVG渐变元素_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 y2: SVG动画长度_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG线性渐变元素_:SVGLinearGradientElement }
...
接口 SVG线元素_ 扩展 SVG图形元素_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 y2: SVG动画长度_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG线元素_:SVGLineElement }
...
接口 SVG标记元素_ 扩展 SVG元素_, SVG适合于视图框_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 refY: SVG动画长度_;
    //@@{ 置方向到角:setOrientToAngle, SVG角_:SVGAngle }
    置方向到角(角: SVG角_): 无值;
    ...
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG标记元素_:SVGMarkerElement }
...
接口 SVG遮罩元素_ 扩展 SVG元素_, SVG测试_, SVG单位类型_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 y: SVG动画长度_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG遮罩元素_:SVGMaskElement }
...
接口 SVG矩阵_ {
    ...
    逆向(): SVG矩阵_;
    //@@{ 乘:multiply, SVG矩阵_:SVGMatrix }
    乘(第二个矩阵: SVG矩阵_): SVG矩阵_;
    //@@{ 旋转:rotate, SVG矩阵_:SVGMatrix }
    旋转(角: 数字): SVG矩阵_;
    //@@{ 旋转从向量:rotateFromVector, SVG矩阵_:SVGMatrix }
    旋转从向量(x: 数字, y: 数字): SVG矩阵_;
    //@@{ 缩放:scale, SVG矩阵_:SVGMatrix }
    缩放(缩放因子: 数字): SVG矩阵_;
    //@@{ 非统一缩放:scaleNonUniform, SVG矩阵_:SVGMatrix }
    非统一缩放(比例因子X: 数字, 比例因子Y: 数字): SVG矩阵_;
    //@@{ 倾斜X:skewX, SVG矩阵_:SVGMatrix }
    倾斜X(角: 数字): SVG矩阵_;
    //@@{ 倾斜Y:skewY, SVG矩阵_:SVGMatrix }
    倾斜Y(角: 数字): SVG矩阵_;
...
接口 SVG元数据元素_ 扩展 SVG元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG元数据元素_:SVGMetadataElement }
...
接口 SVG数字列表_ {
    //@@{ 条目数量:numberOfItems }
    只读 条目数量: 数字;
    //@@{ 附加项目:appendItem, SVG数字_:SVGNumber }
    附加项目(新项目: SVG数字_): SVG数字_;
    //@@{ 清除:clear }
    清除(): 无值;
    //@@{ 取项目:getItem, SVG数字_:SVGNumber }
    取项目(索引: 数字): SVG数字_;
    //@@{ 初始化:initialize, SVG数字_:SVGNumber }
    初始化(新项目: SVG数字_): SVG数字_;
    //@@{ 插入项目之前:insertItemBefore, SVG数字_:SVGNumber }
    插入项目之前(新项目: SVG数字_, 索引: 数字): SVG数字_;
    //@@{ 删除项目:removeItem, SVG数字_:SVGNumber }
    删除项目(索引: 数字): SVG数字_;
    //@@{ 替换项目:replaceItem, SVG数字_:SVGNumber }
...
接口 SVG路径元素_ 扩展 SVG图形元素_ {
    ...
    只读 路径段列表: SVG路径段列表_;
    //@@{ 创建SVG路径段弧绝对:createSVGPathSegArcAbs, SVG路径段弧绝对_:SVGPathSegArcAbs }
    创建SVG路径段弧绝对(x: 数字, y: 数字, r1: 数字, r2: 数字, 角: 数字, 大弧标志: 真假, 扫描标志: 真假): SVG路径段弧绝对_;
    //@@{ 创建SVG路径段弧相对:createSVGPathSegArcRel, SVG路径段弧相对_:SVGPathSegArcRel }
    ...
    //@@{ 取路径段长度:getPathSegAtLength }
    取路径段长度(距离: 数字): 数字;
    //@@{ 取点在长度:getPointAtLength, SVG点_:SVGPoint }
    取点在长度(距离: 数字): SVG点_;
    //@@{ 取总长度:getTotalLength }
    取总长度(): 数字;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG路径元素_:SVGPathElement }
...
接口 SVG路径段列表_ {
    //@@{ 条目的数量:numberOfItems }
    只读 条目的数量: 数字;
    //@@{ 附加项目:appendItem, SVG路径段_:SVGPathSeg }
    附加项目(新项目: SVG路径段_): SVG路径段_;
    //@@{ 清除:clear }
    清除(): 无值;
    //@@{ 取项目:getItem, SVG路径段_:SVGPathSeg }
    取项目(索引: 数字): SVG路径段_;
    //@@{ 初始化:initialize, SVG路径段_:SVGPathSeg }
    初始化(新项目: SVG路径段_): SVG路径段_;
    //@@{ 插入项目之前:insertItemBefore, SVG路径段_:SVGPathSeg }
    插入项目之前(新项目: SVG路径段_, 索引: 数字): SVG路径段_;
    //@@{ 删除项目:removeItem, SVG路径段_:SVGPathSeg }
    删除项目(索引: 数字): SVG路径段_;
    //@@{ 替换项目:replaceItem, SVG路径段_:SVGPathSeg }
...
接口 SVG模式元素_ 扩展 SVG元素_, SVG测试_, SVG单位类型_, SVG适合于视图框_, SVGURI参考_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 y: SVG动画长度_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG模式元素_:SVGPatternElement }
...
接口 SVG点_ {
    x: 数字;
    y: 数字;
    //@@{ 矩阵变换:matrixTransform, SVG矩阵_:SVGMatrix, SVG点_:SVGPoint }
...
接口 SVG点列表_ {
    //@@{ 条目的数量:numberOfItems }
    只读 条目的数量: 数字;
    //@@{ 附加项目:appendItem, SVG点_:SVGPoint }
    附加项目(新项目: SVG点_): SVG点_;
    //@@{ 清除:clear }
    清除(): 无值;
    //@@{ 取项目:getItem, SVG点_:SVGPoint }
    取项目(索引: 数字): SVG点_;
    //@@{ 初始化:initialize, SVG点_:SVGPoint }
    初始化(新项目: SVG点_): SVG点_;
    //@@{ 插入项目之前:insertItemBefore, SVG点_:SVGPoint }
    插入项目之前(新项目: SVG点_, 索引: 数字): SVG点_;
    //@@{ 删除项目:removeItem, SVG点_:SVGPoint }
    删除项目(索引: 数字): SVG点_;
    //@@{ 替换项目:replaceItem, SVG点_:SVGPoint }
...
接口 SVG多边形元素_ 扩展 SVG图形元素_, SVG动画点_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG多边形元素_:SVGPolygonElement }
...
接口 SVG折线元素_ 扩展 SVG图形元素_, SVG动画点_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG折线元素_:SVGPolylineElement }
...
接口 SVG径向渐变元素_ 扩展 SVG渐变元素_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 r: SVG动画长度_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG径向渐变元素_:SVGRadialGradientElement }
...
接口 SVG矩形元素_ 扩展 SVG图形元素_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 y: SVG动画长度_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG矩形元素_:SVGRectElement }
...
接口 SVG脚本元素_ 扩展 SVG元素_, SVGURI参考_ {
    //@@{ 类型:type }
    类型: 文字;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG脚本元素_:SVGScriptElement }
...
接口 SVG停止元素_ 扩展 SVG元素_ {
    //@@{ 偏移:offset, SVG动画数字_:SVGAnimatedNumber }
    只读 偏移: SVG动画数字_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG停止元素_:SVGStopElement }
...
接口 SVG样式元素_ 扩展 SVG元素_ {
    ...
    //@@{ 类型:type }
    类型: 文字;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG样式元素_:SVGStyleElement }
...
接口 SVGSVG元素_ 扩展 SVG图形元素_, 文档事件_, SVG适合于视图框_, SVG放缩及平移_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 y: SVG动画长度_;
    //@@{ 检查外壳:checkEnclosure, SVG元素_:SVGElement, SVG矩形_:SVGRect }
    检查外壳(元素: SVG元素_, 矩形: SVG矩形_): 真假;
    //@@{ 检查交叉:checkIntersection, SVG元素_:SVGElement, SVG矩形_:SVGRect }
    ...
    创建SVG转换(): SVG转换_;
    //@@{ 创建SVG转换从矩阵:createSVGTransformFromMatrix, SVG矩阵_:SVGMatrix, SVG转换_:SVGTransform }
    ...
    //@@{ 取交叉列表:getIntersectionList, SVG矩形_:SVGRect, SVG元素_:SVGElement, 节点列表的_:NodeListOf, SVG圆元素_:SVGCircleElement, SVG椭圆元素_:SVGEllipseElement, SVG图像元素_:SVGImageElement, SVG线元素_:SVGLineElement, SVG路径元素_:SVGPathElement, SVG多边形元素_:SVGPolygonElement, SVG折线元素_:SVGPolylineElement, SVG矩形元素_:SVGRectElement, SVG文本元素_:SVGTextElement, SVG使用元素_:SVGUseElement }
    ...
    取消停止所有重绘(): 无值;
    //@@{ 添加事件监听器:addEventListener, SVGSVG元素事件映射_:SVGSVGElementEventMap, SVGSVG元素_:SVGSVGElement }
...
接口 SVG分支元素_ 扩展 SVG图形元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG分支元素_:SVGSwitchElement }
...
接口 SVG符号元素_ 扩展 SVG元素_, SVG适合于视图框_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG符号元素_:SVGSymbolElement }
...
接口 SVG文本内容元素_ 扩展 SVG图形元素_ {
    ...
    只读 文本长度: SVG动画长度_;
    //@@{ 取字符值在位置:getCharNumAtPosition, SVG点_:SVGPoint }
    取字符值在位置(点: SVG点_): 数字;
    //@@{ 取计算文本长度:getComputedTextLength }
    取计算文本长度(): 数字;
    //@@{ 取字符的结束位置:getEndPositionOfChar, SVG点_:SVGPoint }
    取字符的结束位置(字符值: 数字): SVG点_;
    //@@{ 取字符的范围:getExtentOfChar, SVG矩形_:SVGRect }
    取字符的范围(字符值: 数字): SVG矩形_;
    //@@{ 取字符的数量:getNumberOfChars }
    取字符的数量(): 数字;
    //@@{ 取字符的旋转:getRotationOfChar }
    取字符的旋转(字符值: 数字): 数字;
    //@@{ 取开始字符的位置:getStartPositionOfChar, SVG点_:SVGPoint }
    取开始字符的位置(字符值: 数字): SVG点_;
    //@@{ 取子字符串长度:getSubStringLength }
    取子字符串长度(字符值: 数字, 字符数量: 数字): 数字;
    //@@{ 选择子字符串:selectSubString }
    ...
    只读 __长度调整_未知__: 数字;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG文本内容元素_:SVGTextContentElement }
...
接口 SVG文本元素_ 扩展 SVG文本点位元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG文本元素_:SVGTextElement }
...
接口 SVG文本路径元素_ 扩展 SVG文本内容元素_, SVGURI参考_ {
    ...
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG文本路径元素_:SVGTextPathElement }
...
接口 SVG文本点位元素_ 扩展 SVG文本内容元素_ {
    ...
    //@@{ SVG动画长度列表_:SVGAnimatedLengthList }
    只读 y: SVG动画长度列表_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG文本点位元素_:SVGTextPositioningElement }
...
接口 SVG标题元素_ 扩展 SVG元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG标题元素_:SVGTitleElement }
...
接口 SVG转换_ {
    ...
    //@@{ 类型:type }
    只读 类型: 数字;
    //@@{ 置矩阵:setMatrix, SVG矩阵_:SVGMatrix }
    置矩阵(矩阵: SVG矩阵_): 无值;
    //@@{ 置旋转:setRotate }
...
接口 SVG转换列表_ {
    //@@{ 条目的数量:numberOfItems }
    只读 条目的数量: 数字;
    //@@{ 附加项目:appendItem, SVG转换_:SVGTransform }
    ...
    //@@{ 创建SVG转换从矩阵:createSVGTransformFromMatrix, SVG矩阵_:SVGMatrix, SVG转换_:SVGTransform }
    创建SVG转换从矩阵(矩阵: SVG矩阵_): SVG转换_;
    //@@{ 取项目:getItem, SVG转换_:SVGTransform }
    取项目(索引: 数字): SVG转换_;
    //@@{ 初始化:initialize, SVG转换_:SVGTransform }
    初始化(新项目: SVG转换_): SVG转换_;
    //@@{ 插入项目之前:insertItemBefore, SVG转换_:SVGTransform }
    插入项目之前(新项目: SVG转换_, 索引: 数字): SVG转换_;
    //@@{ 删除项目:removeItem, SVG转换_:SVGTransform }
    删除项目(索引: 数字): SVG转换_;
    //@@{ 替换项目:replaceItem, SVG转换_:SVGTransform }
...
接口 SVG文本跨度元素_ 扩展 SVG文本点位元素_ {
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG文本跨度元素_:SVGTSpanElement }
...
接口 SVG使用元素_ 扩展 SVG图形元素_, SVGURI参考_ {
    ...
    //@@{ SVG动画长度_:SVGAnimatedLength }
    只读 y: SVG动画长度_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG使用元素_:SVGUseElement }
...
接口 SVG视图元素_ 扩展 SVG元素_, SVG放缩及平移_, SVG适合于视图框_ {
    ...
    只读 视图目标: SVG文字列表_;
    //@@{ 添加事件监听器:addEventListener, SVG元素事件映射_:SVGElementEventMap, SVG视图元素_:SVGViewElement }
...
接口 文本事件_ 扩展 UI事件_ {
    ...
    //@@{ 语言环境:locale }
    只读 语言环境: 文字;
    //@@{ 初始化文本事件:initTextEvent, 窗口_:Window }
...
接口 文本轨道_ 扩展 事件目标_ {
    ...
    //@@{ 就绪状态:readyState }
    只读 就绪状态: 数字;
    //@@{ 添加提示:addCue, 文本轨道提示_:TextTrackCue }
    添加提示(提示: 文本轨道提示_): 无值;
    //@@{ 删除提示:removeCue, 文本轨道提示_:TextTrackCue }
    删除提示(提示: 文本轨道提示_): 无值;
    //@@{ __禁用__:DISABLED }
    只读 __禁用__: 数字;
    //@@{ __错误__:ERROR }
    ...
    //@@{ __显示的__:SHOWING }
    只读 __显示的__: 数字;
    //@@{ 添加事件监听器:addEventListener, 文本轨道事件映射_:TextTrackEventMap, 文本轨道_:TextTrack }
...
接口 文本轨道提示_ 扩展 事件目标_ {
    ...
    取提示转为HTML(): 文档片段_;
    //@@{ 添加事件监听器:addEventListener, 文本轨道提示事件映射_:TextTrackCueEventMap, 文本轨道提示_:TextTrackCue }
    添加事件监听器<K 扩展 键为 文本轨道提示事件映射_>(类型: K, 侦听器: (本体: 文本轨道提示_, ev: 文本轨道提示事件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ 文本轨道提示_:TextTrackCue }
声明 值量 文本轨道提示_: {
...
接口 文本轨道列表_ 扩展 事件目标_ {
    ...
    //@@{ 项目:item, 文本轨道_:TextTrack }
    项目(索引: 数字): 文本轨道_;
    //@@{ 添加事件监听器:addEventListener, 文本轨道列表事件映射_:TextTrackListEventMap, 文本轨道列表_:TextTrackList }
...
声明 值量 触摸事件_: {
    ...
    原型: 触摸事件_;
    //@@{ 触摸事件初始化_:TouchEventInit, 触摸事件_:TouchEvent }
...
声明 值量 轨道事件_: {
    ...
    原型: 轨道事件_;
    //@@{ 轨道事件初始化_:TrackEventInit, 轨道事件_:TrackEvent }
...
声明 值量 过渡事件_: {
    ...
    原型: 过渡事件_;
    //@@{ 过渡事件初始化_:TransitionEventInit, 过渡事件_:TransitionEvent }
...
接口 UI事件_ 扩展 事件_ {
    ...
    //@@{ 视图:view, 窗口_:Window }
    只读 视图: 窗口_;
    //@@{ 初始化UI事件:initUIEvent, 窗口_:Window }
...
声明 值量 UI事件_: {
    ...
    原型: UI事件_;
    //@@{ UI事件初始化_:UIEventInit, UI事件_:UIEvent }
...
声明 值量 URL: {
    ...
    原型: URL;
    新建(url: 文字, 基?: 文字): URL;
    //@@{ 创建对象URL:createObjectURL, 对象URL选项_:ObjectURLOptions }
...
接口 视频轨道列表_ 扩展 事件目标_ {
    ...
    //@@{ 项目:item, 视频轨道_:VideoTrack }
    项目(索引: 数字): 视频轨道_;
    //@@{ 添加事件监听器:addEventListener, 视频轨道列表事件映射_:VideoTrackListEventMap, 视频轨道列表_:VideoTrackList }
...
接口 网络身份验证_ {
    //@@{ 取断言:getAssertion, 断言选项_:AssertionOptions, 预设_:Promise, Web认证断言_:WebAuthnAssertion }
    取断言(断言挑战: 任意, 选项?: 断言选项_): 预设_<Web认证断言_>;
    //@@{ 标记凭证:makeCredential, 账户_:Account, 作用域凭据参数_:ScopedCredentialParameters, 作用域凭据选项_:ScopedCredentialOptions, 预设_:Promise, 作用域凭据信息_:ScopedCredentialInfo }
...
//@@{ WebGL上下文事件_:WebGLContextEvent }
声明 值量 WebGL上下文事件_: {
    //@@{ 原型:prototype, WebGL上下文事件_:WebGLContextEvent }
    原型: WebGL上下文事件_;
    //@@{ WebGL上下文事件初始化_:WebGLContextEventInit, WebGL上下文事件_:WebGLContextEvent }
...
接口 WebGL渲染上下文_ {
    ...
    //@@{ 活跃的纹理:activeTexture }
    活跃的纹理(纹理: 数字): 无值;
    //@@{ 附加材质:attachShader, WebGL程序_:WebGLProgram, WebGL材质_:WebGLShader }
    附加材质(程序: WebGL程序_ | 空值, 材质: WebGL材质_ | 空值): 无值;
    //@@{ 绑定属性位置:bindAttribLocation, WebGL程序_:WebGLProgram }
    绑定属性位置(程序: WebGL程序_ | 空值, 索引: 数字, 名字: 文字): 无值;
    //@@{ 绑定缓冲:bindBuffer, WebGL缓冲_:WebGLBuffer }
    绑定缓冲(目标: 数字, 缓冲: WebGL缓冲_ | 空值): 无值;
    //@@{ 绑定帧缓冲区:bindFramebuffer, WebGL帧缓冲区_:WebGLFramebuffer }
    绑定帧缓冲区(目标: 数字, 帧缓冲区: WebGL帧缓冲区_ | 空值): 无值;
    //@@{ 绑定渲染缓冲区:bindRenderbuffer, WebGL渲染缓冲区_:WebGLRenderbuffer }
    绑定渲染缓冲区(目标: 数字, 渲染缓冲: WebGL渲染缓冲区_ | 空值): 无值;
    //@@{ 绑定纹理:bindTexture, WebGL纹理_:WebGLTexture }
    绑定纹理(目标: 数字, 纹理: WebGL纹理_ | 空值): 无值;
    //@@{ 混合颜色:blendColor }
    混合颜色(红: 数字, 绿: 数字, 蓝: 数字, 透明: 数字): 无值;
    //@@{ 混合方程:blendEquation }
    混合方程(模式: 数字): 无值;
    //@@{ 混合方程分离:blendEquationSeparate }
    混合方程分离(模式RGB: 数字, 模式透明: 数字): 无值;
    //@@{ 混合函数:blendFunc }
    混合函数(源因素: 数字, 目标因素: 数字): 无值;
    //@@{ 混合函数单独:blendFuncSeparate }
    混合函数单独(源RGB: 数字, 目标RGB: 数字, 源透明: 数字, 目标透明: 数字): 无值;
    //@@{ 缓冲数据:bufferData, 数组缓冲区视图_:ArrayBufferView, 数组缓冲区_:ArrayBuffer }
    缓冲数据(目标: 数字, 大小: 数字 | 数组缓冲区视图_ | 数组缓冲区_, 使用: 数字): 无值;
    //@@{ 缓冲子数据:bufferSubData, 数组缓冲区视图_:ArrayBufferView, 数组缓冲区_:ArrayBuffer }
    缓冲子数据(目标: 数字, 偏移: 数字, 数据: 数组缓冲区视图_ | 数组缓冲区_): 无值;
    //@@{ 检查帧缓冲区状态:checkFramebufferStatus }
    检查帧缓冲区状态(目标: 数字): 数字;
    //@@{ 清除:clear }
    清除(遮罩: 数字): 无值;
    //@@{ 清除颜色:clearColor }
    ...
    //@@{ 创建材质:createShader, WebGL材质_:WebGLShader }
    创建材质(类型: 数字): WebGL材质_ | 空值;
    //@@{ 创建纹理:createTexture, WebGL纹理_:WebGLTexture }
    创建纹理(): WebGL纹理_ | 空值;
    //@@{ 剔除表面:cullFace }
    剔除表面(模式: 数字): 无值;
    //@@{ 删除缓冲区:deleteBuffer, WebGL缓冲_:WebGLBuffer }
    删除缓冲区(缓冲: WebGL缓冲_ | 空值): 无值;
    //@@{ 删除帧缓冲区:deleteFramebuffer, WebGL帧缓冲区_:WebGLFramebuffer }
    删除帧缓冲区(帧缓冲区: WebGL帧缓冲区_ | 空值): 无值;
    //@@{ 删除程序:deleteProgram, WebGL程序_:WebGLProgram }
    删除程序(程序: WebGL程序_ | 空值): 无值;
    //@@{ 删除渲染缓冲区:deleteRenderbuffer, WebGL渲染缓冲区_:WebGLRenderbuffer }
    删除渲染缓冲区(渲染缓冲: WebGL渲染缓冲区_ | 空值): 无值;
    //@@{ 删除材质:deleteShader, WebGL材质_:WebGLShader }
    删除材质(材质: WebGL材质_ | 空值): 无值;
    //@@{ 删除纹理:deleteTexture, WebGL纹理_:WebGLTexture }
    ...
    //@@{ 深度范围:depthRange }
    深度范围(z近: 数字, z远: 数字): 无值;
    //@@{ 分离材质:detachShader, WebGL程序_:WebGLProgram, WebGL材质_:WebGLShader }
    ...
    //@@{ 启用:enable }
    启用(帽: 数字): 无值;
    //@@{ 启用顶点属性数组:enableVertexAttribArray }
    启用顶点属性数组(索引: 数字): 无值;
    //@@{ 完成:finish }
    完成(): 无值;
    //@@{ 冲洗:flush }
    冲洗(): 无值;
    //@@{ 帧缓冲区渲染缓冲区:framebufferRenderbuffer, WebGL渲染缓冲区_:WebGLRenderbuffer }
    帧缓冲区渲染缓冲区(目标: 数字, 附件: 数字, 渲染缓冲区目标: 数字, 渲染缓冲: WebGL渲染缓冲区_ | 空值): 无值;
    //@@{ 帧缓冲区纹理2D:framebufferTexture2D, WebGL纹理_:WebGLTexture }
    帧缓冲区纹理2D(目标: 数字, 附件: 数字, 贴图目标: 数字, 纹理: WebGL纹理_ | 空值, 水平: 数字): 无值;
    //@@{ 前面:frontFace }
    前面(模式: 数字): 无值;
    //@@{ 生成贴图映射:generateMipmap }
    生成贴图映射(目标: 数字): 无值;
    //@@{ 取活跃的属性:getActiveAttrib, WebGL程序_:WebGLProgram, WebGL活动信息_:WebGLActiveInfo }
    取活跃的属性(程序: WebGL程序_ | 空值, 索引: 数字): WebGL活动信息_ | 空值;
    //@@{ 取活跃的统一:getActiveUniform, WebGL程序_:WebGLProgram, WebGL活动信息_:WebGLActiveInfo }
    取活跃的统一(程序: WebGL程序_ | 空值, 索引: 数字): WebGL活动信息_ | 空值;
    //@@{ 取附加材质:getAttachedShaders, WebGL程序_:WebGLProgram, WebGL材质_:WebGLShader }
    取附加材质(程序: WebGL程序_ | 空值): WebGL材质_[] | 空值;
    //@@{ 取特性位置:getAttribLocation, WebGL程序_:WebGLProgram }
    ...
    //@@{ 取扩展:getExtension }
    取扩展(名字: 文字): 任意;
    //@@{ 取帧缓冲区附件参数:getFramebufferAttachmentParameter }
    取帧缓冲区附件参数(目标: 数字, 附件: 数字, 参数名称: 数字): 任意;
    //@@{ 取参数:getParameter }
    取参数(参数名称: 数字): 任意;
    //@@{ 取程序信息日志:getProgramInfoLog, WebGL程序_:WebGLProgram }
    取程序信息日志(程序: WebGL程序_ | 空值): 文字 | 空值;
    //@@{ 取程序参数:getProgramParameter, WebGL程序_:WebGLProgram }
    取程序参数(程序: WebGL程序_ | 空值, 参数名称: 数字): 任意;
    //@@{ 取渲染缓冲区参数:getRenderbufferParameter }
    取渲染缓冲区参数(目标: 数字, 参数名称: 数字): 任意;
    //@@{ 取材质信息日志:getShaderInfoLog, WebGL材质_:WebGLShader }
    取材质信息日志(材质: WebGL材质_ | 空值): 文字 | 空值;
    //@@{ 取材质参数:getShaderParameter, WebGL材质_:WebGLShader }
    取材质参数(材质: WebGL材质_ | 空值, 参数名称: 数字): 任意;
    //@@{ 取材质精度格式:getShaderPrecisionFormat, WebGL材质精度格式_:WebGLShaderPrecisionFormat }
    取材质精度格式(材质类型: 数字, 精密型: 数字): WebGL材质精度格式_ | 空值;
    //@@{ 取材质源:getShaderSource, WebGL材质_:WebGLShader }
    取材质源(材质: WebGL材质_ | 空值): 文字 | 空值;
    //@@{ 取支持扩展:getSupportedExtensions }
    取支持扩展(): 文字[] | 空值;
    //@@{ 取贴图参数:getTexParameter }
    取贴图参数(目标: 数字, 参数名称: 数字): 任意;
    //@@{ 取统一:getUniform, WebGL程序_:WebGLProgram, WebGL统一位置_:WebGLUniformLocation }
    取统一(程序: WebGL程序_ | 空值, 位置: WebGL统一位置_ | 空值): 任意;
    //@@{ 得到统一位置:getUniformLocation, WebGL程序_:WebGLProgram, WebGL统一位置_:WebGLUniformLocation }
    得到统一位置(程序: WebGL程序_ | 空值, 名字: 文字): WebGL统一位置_ | 空值;
    //@@{ 取顶点属性:getVertexAttrib }
    取顶点属性(索引: 数字, 参数名称: 数字): 任意;
    //@@{ 取顶点属性偏移:getVertexAttribOffset }
    取顶点属性偏移(索引: 数字, 参数名称: 数字): 数字;
    //@@{ 提示:hint }
    提示(目标: 数字, 模式: 数字): 无值;
    //@@{ 是缓冲区:isBuffer, WebGL缓冲_:WebGLBuffer }
    是缓冲区(缓冲: WebGL缓冲_ | 空值): 真假;
    //@@{ 上下文丢失:isContextLost }
    上下文丢失(): 真假;
    //@@{ 是启用:isEnabled }
    是启用(帽: 数字): 真假;
    //@@{ 是帧缓冲区:isFramebuffer, WebGL帧缓冲区_:WebGLFramebuffer }
    是帧缓冲区(帧缓冲区: WebGL帧缓冲区_ | 空值): 真假;
    //@@{ 是程序:isProgram, WebGL程序_:WebGLProgram }
    是程序(程序: WebGL程序_ | 空值): 真假;
    //@@{ 是渲染缓冲区:isRenderbuffer, WebGL渲染缓冲区_:WebGLRenderbuffer }
    是渲染缓冲区(渲染缓冲: WebGL渲染缓冲区_ | 空值): 真假;
    //@@{ 是材质:isShader, WebGL材质_:WebGLShader }
    是材质(材质: WebGL材质_ | 空值): 真假;
    //@@{ 是纹理:isTexture, WebGL纹理_:WebGLTexture }
    是纹理(纹理: WebGL纹理_ | 空值): 真假;
    //@@{ 线宽:lineWidth }
    线宽(宽度: 数字): 无值;
    //@@{ 链接程序:linkProgram, WebGL程序_:WebGLProgram }
    链接程序(程序: WebGL程序_ | 空值): 无值;
    //@@{ 像素商店:pixelStorei }
    像素商店(参数名称: 数字, 参数: 数字 | 真假): 无值;
    //@@{ 多边形偏移:polygonOffset }
    多边形偏移(因素: 数字, 单位: 数字): 无值;
    //@@{ 读取像素:readPixels, 数组缓冲区视图_:ArrayBufferView }
    读取像素(x: 数字, y: 数字, 宽度: 数字, 高度: 数字, 格式: 数字, 类型: 数字, 像素: 数组缓冲区视图_ | 空值): 无值;
    //@@{ 渲染缓冲存储:renderbufferStorage }
    渲染缓冲存储(目标: 数字, 内部格式: 数字, 宽度: 数字, 高度: 数字): 无值;
    //@@{ 样本覆盖:sampleCoverage }
    样本覆盖(值: 数字, 反: 真假): 无值;
    //@@{ 剪刀:scissor }
    剪刀(x: 数字, y: 数字, 宽度: 数字, 高度: 数字): 无值;
    //@@{ 材质源:shaderSource, WebGL材质_:WebGLShader }
    材质源(材质: WebGL材质_ | 空值, 源: 文字): 无值;
    //@@{ 模板函数:stencilFunc }
    模板函数(函: 数字, 引用: 数字, 遮罩: 数字): 无值;
    //@@{ 模板函数单独:stencilFuncSeparate }
    模板函数单独(家族: 数字, 函: 数字, 引用: 数字, 遮罩: 数字): 无值;
    //@@{ 钢网遮罩:stencilMask }
    钢网遮罩(遮罩: 数字): 无值;
    //@@{ 模板遮罩单独:stencilMaskSeparate }
    模板遮罩单独(家族: 数字, 遮罩: 数字): 无值;
    //@@{ 模板运算:stencilOp }
    模板运算(失败: 数字, Z失败: 数字, Z传: 数字): 无值;
    //@@{ 模板Op单独:stencilOpSeparate }
    模板Op单独(家族: 数字, 失败: 数字, Z失败: 数字, Z传: 数字): 无值;
    //@@{ 贴图图像2D:texImage2D, 数组缓冲区视图_:ArrayBufferView }
    贴图图像2D(目标: 数字, 水平: 数字, 内部格式: 数字, 宽度: 数字, 高度: 数字, 边框: 数字, 格式: 数字, 类型: 数字, 像素: 数组缓冲区视图_ | 空值): 无值;
    //@@{ 贴图图像2D:texImage2D, 位图图像_:ImageBitmap, 图像数据_:ImageData, HTML视频元素_:HTMLVideoElement, HTML图像元素_:HTMLImageElement, HTML画板元素_:HTMLCanvasElement }
    贴图图像2D(目标: 数字, 水平: 数字, 内部格式: 数字, 格式: 数字, 类型: 数字, 像素: 位图图像_ | 图像数据_ | HTML视频元素_ | HTML图像元素_ | HTML画板元素_): 无值;
    //@@{ 贴图相关参数f:texParameterf }
    贴图相关参数f(目标: 数字, 参数名称: 数字, 参数: 数字): 无值;
    //@@{ 贴图相关参数:texParameteri }
    贴图相关参数(目标: 数字, 参数名称: 数字, 参数: 数字): 无值;
    //@@{ 贴图子图像2D:texSubImage2D, 数组缓冲区视图_:ArrayBufferView }
    贴图子图像2D(目标: 数字, 水平: 数字, x偏移: 数字, y偏移: 数字, 宽度: 数字, 高度: 数字, 格式: 数字, 类型: 数字, 像素: 数组缓冲区视图_ | 空值): 无值;
    //@@{ 贴图子图像2D:texSubImage2D, 位图图像_:ImageBitmap, 图像数据_:ImageData, HTML视频元素_:HTMLVideoElement, HTML图像元素_:HTMLImageElement, HTML画板元素_:HTMLCanvasElement }
    贴图子图像2D(目标: 数字, 水平: 数字, x偏移: 数字, y偏移: 数字, 格式: 数字, 类型: 数字, 像素: 位图图像_ | 图像数据_ | HTML视频元素_ | HTML图像元素_ | HTML画板元素_): 无值;
    //@@{ 统一1f:uniform1f, WebGL统一位置_:WebGLUniformLocation }
    统一1f(位置: WebGL统一位置_ | 空值, x: 数字): 无值;
    //@@{ 统一1fv:uniform1fv, WebGL统一位置_:WebGLUniformLocation, 浮点数组32_:Float32Array }
    统一1fv(位置: WebGL统一位置_, v: 浮点数组32_ | 数字[]): 无值;
    //@@{ 统一1i:uniform1i, WebGL统一位置_:WebGLUniformLocation }
    统一1i(位置: WebGL统一位置_ | 空值, x: 数字): 无值;
    //@@{ 统一1iv:uniform1iv, WebGL统一位置_:WebGLUniformLocation, 整数数组32_:Int32Array }
    统一1iv(位置: WebGL统一位置_, v: 整数数组32_ | 数字[]): 无值;
    //@@{ 统一2f:uniform2f, WebGL统一位置_:WebGLUniformLocation }
    统一2f(位置: WebGL统一位置_ | 空值, x: 数字, y: 数字): 无值;
    //@@{ 统一2fv:uniform2fv, WebGL统一位置_:WebGLUniformLocation, 浮点数组32_:Float32Array }
    统一2fv(位置: WebGL统一位置_, v: 浮点数组32_ | 数字[]): 无值;
    //@@{ 统一2i:uniform2i, WebGL统一位置_:WebGLUniformLocation }
    统一2i(位置: WebGL统一位置_ | 空值, x: 数字, y: 数字): 无值;
    //@@{ 统一2iv:uniform2iv, WebGL统一位置_:WebGLUniformLocation, 整数数组32_:Int32Array }
    统一2iv(位置: WebGL统一位置_, v: 整数数组32_ | 数字[]): 无值;
    //@@{ 统一3f:uniform3f, WebGL统一位置_:WebGLUniformLocation }
    统一3f(位置: WebGL统一位置_ | 空值, x: 数字, y: 数字, z: 数字): 无值;
    //@@{ 统一3fv:uniform3fv, WebGL统一位置_:WebGLUniformLocation, 浮点数组32_:Float32Array }
    统一3fv(位置: WebGL统一位置_, v: 浮点数组32_ | 数字[]): 无值;
    //@@{ 统一3i:uniform3i, WebGL统一位置_:WebGLUniformLocation }
    统一3i(位置: WebGL统一位置_ | 空值, x: 数字, y: 数字, z: 数字): 无值;
    //@@{ 统一3iv:uniform3iv, WebGL统一位置_:WebGLUniformLocation, 整数数组32_:Int32Array }
    统一3iv(位置: WebGL统一位置_, v: 整数数组32_ | 数字[]): 无值;
    //@@{ 统一4f:uniform4f, WebGL统一位置_:WebGLUniformLocation }
    统一4f(位置: WebGL统一位置_ | 空值, x: 数字, y: 数字, z: 数字, w: 数字): 无值;
    //@@{ 统一4fv:uniform4fv, WebGL统一位置_:WebGLUniformLocation, 浮点数组32_:Float32Array }
    统一4fv(位置: WebGL统一位置_, v: 浮点数组32_ | 数字[]): 无值;
    //@@{ 统一4i:uniform4i, WebGL统一位置_:WebGLUniformLocation }
    统一4i(位置: WebGL统一位置_ | 空值, x: 数字, y: 数字, z: 数字, w: 数字): 无值;
    //@@{ 统一4iv:uniform4iv, WebGL统一位置_:WebGLUniformLocation, 整数数组32_:Int32Array }
    统一4iv(位置: WebGL统一位置_, v: 整数数组32_ | 数字[]): 无值;
    //@@{ 统一矩阵2fv:uniformMatrix2fv, WebGL统一位置_:WebGLUniformLocation, 浮点数组32_:Float32Array }
    统一矩阵2fv(位置: WebGL统一位置_, 转置: 真假, 值: 浮点数组32_ | 数字[]): 无值;
    //@@{ 统一矩阵3fv:uniformMatrix3fv, WebGL统一位置_:WebGLUniformLocation, 浮点数组32_:Float32Array }
    统一矩阵3fv(位置: WebGL统一位置_, 转置: 真假, 值: 浮点数组32_ | 数字[]): 无值;
    //@@{ 统一矩阵4fv:uniformMatrix4fv, WebGL统一位置_:WebGLUniformLocation, 浮点数组32_:Float32Array }
    统一矩阵4fv(位置: WebGL统一位置_, 转置: 真假, 值: 浮点数组32_ | 数字[]): 无值;
    //@@{ 使用程序:useProgram, WebGL程序_:WebGLProgram }
    使用程序(程序: WebGL程序_ | 空值): 无值;
    //@@{ 验证程序:validateProgram, WebGL程序_:WebGLProgram }
    验证程序(程序: WebGL程序_ | 空值): 无值;
    //@@{ 顶点属性1f:vertexAttrib1f }
    顶点属性1f(indx: 数字, x: 数字): 无值;
    //@@{ 顶点属性1fv:vertexAttrib1fv, 浮点数组32_:Float32Array }
    顶点属性1fv(属性位置: 数字, 值: 浮点数组32_ | 数字[]): 无值;
    //@@{ 顶点属性2f:vertexAttrib2f }
    顶点属性2f(属性位置: 数字, x: 数字, y: 数字): 无值;
    //@@{ 顶点属性2fv:vertexAttrib2fv, 浮点数组32_:Float32Array }
    顶点属性2fv(属性位置: 数字, 值: 浮点数组32_ | 数字[]): 无值;
    //@@{ 顶点属性3f:vertexAttrib3f }
    顶点属性3f(属性位置: 数字, x: 数字, y: 数字, z: 数字): 无值;
    //@@{ 顶点属性3fv:vertexAttrib3fv, 浮点数组32_:Float32Array }
    顶点属性3fv(属性位置: 数字, 值: 浮点数组32_ | 数字[]): 无值;
    //@@{ 顶点属性4f:vertexAttrib4f }
    顶点属性4f(属性位置: 数字, x: 数字, y: 数字, z: 数字, w: 数字): 无值;
    //@@{ 顶点属性4fv:vertexAttrib4fv, 浮点数组32_:Float32Array }
    顶点属性4fv(属性位置: 数字, 值: 浮点数组32_ | 数字[]): 无值;
    //@@{ 顶点属性指针:vertexAttribPointer }
...
接口 WebKitCSS矩阵_ {
    ...
    逆向(): WebKitCSS矩阵_;
    //@@{ 乘:multiply, WebKitCSS矩阵_:WebKitCSSMatrix }
    乘(第二个矩阵: WebKitCSS矩阵_): WebKitCSS矩阵_;
    //@@{ 旋转:rotate, WebKitCSS矩阵_:WebKitCSSMatrix }
    旋转(角X: 数字, 角Y?: 数字, 角Z?: 数字): WebKitCSS矩阵_;
    //@@{ 轴旋转角:rotateAxisAngle, WebKitCSS矩阵_:WebKitCSSMatrix }
    轴旋转角(x: 数字, y: 数字, z: 数字, 角: 数字): WebKitCSS矩阵_;
    //@@{ 缩放:scale, WebKitCSS矩阵_:WebKitCSSMatrix }
    缩放(规模X: 数字, 规模Y?: 数字, 规模Z?: 数字): WebKitCSS矩阵_;
    //@@{ 置矩阵值:setMatrixValue }
    置矩阵值(值: 文字): 无值;
    //@@{ 倾斜X:skewX, WebKitCSS矩阵_:WebKitCSSMatrix }
    倾斜X(角: 数字): WebKitCSS矩阵_;
    //@@{ 倾斜Y:skewY, WebKitCSS矩阵_:WebKitCSSMatrix }
...
接口 WebKit目录读者_ {
    //@@{ 读条目:readEntries, WebKit条目回调_:WebKitEntriesCallback, WebKit错误回调_:WebKitErrorCallback }
...
接口 WebKit文件条目_ 扩展 WebKit条目_ {
    //@@{ 文件:file, WebKit文件回调_:WebKitFileCallback, WebKit错误回调_:WebKitErrorCallback }
...
接口 webkitRTC对等连接_ 扩展 RTC对等连接_ {
    //@@{ 添加事件监听器:addEventListener, RTC对等连接事件映射_:RTCPeerConnectionEventMap, webkitRTC对等连接_:webkitRTCPeerConnection }
    添加事件监听器<K 扩展 键为 RTC对等连接事件映射_>(类型: K, 侦听器: (本体: webkitRTC对等连接_, ev: RTC对等连接事件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ webkitRTC对等连接_:webkitRTCPeerConnection }
声明 值量 webkitRTC对等连接_: {
    //@@{ 原型:prototype, webkitRTC对等连接_:webkitRTCPeerConnection }
    原型: webkitRTC对等连接_;
    //@@{ RTC配置_:RTCConfiguration, webkitRTC对等连接_:webkitRTCPeerConnection }
...
接口 网络套接字_ 扩展 事件目标_ {
    ...
    //@@{ __打开__:OPEN }
    只读 __打开__: 数字;
    //@@{ 添加事件监听器:addEventListener, 网络套接字事件映射_:WebSocketEventMap, 网络套接字_:WebSocket }
...
接口 轮事件_ 扩展 鼠标事件_ {
    ...
    //@@{ 取当前点:getCurrentPoint, 元素_:Element }
    取当前点(元素: 元素_): 无值;
    //@@{ 初始化轮事件:initWheelEvent, 窗口_:Window, 事件目标_:EventTarget }
...
声明 值量 轮事件_: {
    ...
    原型: 轮事件_;
    //@@{ 循环事件初始化_:WheelEventInit, 轮事件_:WheelEvent }
...
接口 工人_ 扩展 事件目标_, 抽象的工人_ {
    ...
    //@@{ 终止:terminate }
    终止(): 无值;
    //@@{ 添加事件监听器:addEventListener, 工人事件映射_:WorkerEventMap, 工人_:Worker }
...
接口 XML文档_ 扩展 文档_ {
    //@@{ 添加事件监听器:addEventListener, 文档事件映射_:DocumentEventMap, XML文档_:XMLDocument }
...
接口 XMLHttp请求_ 扩展 事件目标_, XMLHttp请求事件目标_ {
    ...
    //@@{ __未寄出__:UNSENT }
    只读 __未寄出__: 数字;
    //@@{ 添加事件监听器:addEventListener, XMLHttp请求事件映射_:XMLHttpRequestEventMap, XMLHttp请求_:XMLHttpRequest }
...
接口 XMLHttp请求上传 扩展 事件目标_, XMLHttp请求事件目标_ {
    //@@{ 添加事件监听器:addEventListener, XMLHttp请求事件目标事件映射_:XMLHttpRequestEventTargetEventMap, XMLHttp请求上传:XMLHttpRequestUpload }
...
接口 XML序列化器_ {
    //@@{ 序列化为字符串:serializeToString, 节点_:Node }
    序列化为字符串(目标: 节点_): 文字;
...
接口 X路径表达式_ {
    //@@{ 评估:evaluate, 节点_:Node, X路径结果_:XPathResult }
...
接口 XSLT处理器_ {
    ...
    //@@{ 导入样式表:importStylesheet, 节点_:Node }
    导入样式表(样式: 节点_): 无值;
    //@@{ 删除参数:removeParameter }
    删除参数(名称空间URI: 文字, 本地名称: 文字): 无值;
    //@@{ 重置:reset }
    重置(): 无值;
    //@@{ 设置参数:setParameter }
    设置参数(名称空间URI: 文字, 本地名称: 文字, 值: 任意): 无值;
    //@@{ 变换到文档:transformToDocument, 节点_:Node, 文档_:Document }
    变换到文档(源: 节点_): 文档_;
    //@@{ 变换到片段:transformToFragment, 节点_:Node, 文档_:Document, 文档片段_:DocumentFragment }
...
接口 抽象的工人_ {
    ...
    //@@{ 添加事件监听器:addEventListener, 抽象的工人事件映射_:AbstractWorkerEventMap, 抽象的工人_:AbstractWorker }
...
//@@{ 文档事件_:DocumentEvent }
接口 文档事件_ {
    //@@{ 创建事件:createEvent, 动画事件_:AnimationEvent }
    创建事件(事件接口: "动画事件_"): 动画事件_;
    //@@{ 创建事件:createEvent, 音频处理事件_:AudioProcessingEvent }
    创建事件(事件接口: "音频处理事件_"): 音频处理事件_;
    //@@{ 创建事件:createEvent, 将卸载事件_:BeforeUnloadEvent }
    创建事件(事件接口: "将卸载事件_"): 将卸载事件_;
    //@@{ 创建事件:createEvent, 剪贴板事件_:ClipboardEvent }
    创建事件(事件接口: "剪贴板事件_"): 剪贴板事件_;
    //@@{ 创建事件:createEvent, 关闭事件_:CloseEvent }
    创建事件(事件接口: "关闭事件_"): 关闭事件_;
    //@@{ 创建事件:createEvent, 组件事件_:CompositionEvent }
    创建事件(事件接口: "组件事件_"): 组件事件_;
    //@@{ 创建事件:createEvent, 自定义事件_:CustomEvent }
    创建事件(事件接口: "自定义事件_"): 自定义事件_;
    //@@{ 创建事件:createEvent, 设备环境光事件_:DeviceLightEvent }
    创建事件(事件接口: "设备环境光事件_"): 设备环境光事件_;
    //@@{ 创建事件:createEvent, 设备运动事件_:DeviceMotionEvent }
    创建事件(事件接口: "设备运动事件_"): 设备运动事件_;
    //@@{ 创建事件:createEvent, 设备定位事件_:DeviceOrientationEvent }
    创建事件(事件接口: "设备定位事件_"): 设备定位事件_;
    //@@{ 创建事件:createEvent, 拖拽事件_:DragEvent }
    创建事件(事件接口: "拖拽事件_"): 拖拽事件_;
    //@@{ 创建事件:createEvent, 错误事件_:ErrorEvent }
    创建事件(事件接口: "错误事件_"): 错误事件_;
    //@@{ 创建事件:createEvent, 事件_:Event }
    创建事件(事件接口: "事件_"): 事件_;
    //@@{ 创建事件:createEvent, 事件_:Event }
    创建事件(事件接口: "事件组_"): 事件_;
    //@@{ 创建事件:createEvent, 焦点事件_:FocusEvent }
    创建事件(事件接口: "焦点事件_"): 焦点事件_;
    //@@{ 创建事件:createEvent, 焦点导航事件_:FocusNavigationEvent }
    创建事件(事件接口: "焦点导航事件_"): 焦点导航事件_;
    //@@{ 创建事件:createEvent, 手柄事件_:GamepadEvent }
    创建事件(事件接口: "手柄事件_"): 手柄事件_;
    //@@{ 创建事件:createEvent, 哈希改变事件_:HashChangeEvent }
    创建事件(事件接口: "哈希改变事件_"): 哈希改变事件_;
    //@@{ 创建事件:createEvent, IDB版本改变事件_:IDBVersionChangeEvent }
    创建事件(事件接口: "IDB版本改变事件_"): IDB版本改变事件_;
    //@@{ 创建事件:createEvent, 键盘事件_:KeyboardEvent }
    创建事件(事件接口: "键盘事件_"): 键盘事件_;
    //@@{ 创建事件:createEvent, 监听状态改变事件_:ListeningStateChangedEvent }
    创建事件(事件接口: "监听状态改变事件_"): 监听状态改变事件_;
    //@@{ 创建事件:createEvent, 检测到长时间运行脚本事件_:LongRunningScriptDetectedEvent }
    创建事件(事件接口: "检测到长时间运行脚本事件_"): 检测到长时间运行脚本事件_;
    //@@{ 创建事件:createEvent, MS手势事件_:MSGestureEvent }
    创建事件(事件接口: "MS手势事件_"): MS手势事件_;
    //@@{ 创建事件:createEvent, MS操纵杆事件_:MSManipulationEvent }
    创建事件(事件接口: "MS操纵杆事件_"): MS操纵杆事件_;
    //@@{ 创建事件:createEvent, MS媒体键消息事件_:MSMediaKeyMessageEvent }
    创建事件(事件接口: "MS媒体键消息事件_"): MS媒体键消息事件_;
    //@@{ 创建事件:createEvent, MS媒体键需要事件_:MSMediaKeyNeededEvent }
    创建事件(事件接口: "MS媒体键需要事件_"): MS媒体键需要事件_;
    //@@{ 创建事件:createEvent, MS指针事件_:MSPointerEvent }
    创建事件(事件接口: "MS指针事件_"): MS指针事件_;
    //@@{ 创建事件:createEvent, MS网站模式事件_:MSSiteModeEvent }
    创建事件(事件接口: "MS网站模式事件_"): MS网站模式事件_;
    //@@{ 创建事件:createEvent, 媒体加密事件_:MediaEncryptedEvent }
    创建事件(事件接口: "媒体加密事件_"): 媒体加密事件_;
    //@@{ 创建事件:createEvent, 媒体键消息事件_:MediaKeyMessageEvent }
    创建事件(事件接口: "媒体键消息事件_"): 媒体键消息事件_;
    //@@{ 创建事件:createEvent, 媒体流错误事件_:MediaStreamErrorEvent }
    创建事件(事件接口: "媒体流错误事件_"): 媒体流错误事件_;
    //@@{ 创建事件:createEvent, 媒体流事件_:MediaStreamEvent }
    创建事件(事件接口: "媒体流事件_"): 媒体流事件_;
    //@@{ 创建事件:createEvent, 媒体流轨道事件_:MediaStreamTrackEvent }
    创建事件(事件接口: "媒体流轨道事件_"): 媒体流轨道事件_;
    //@@{ 创建事件:createEvent, 消息事件_:MessageEvent }
    创建事件(事件接口: "消息事件_"): 消息事件_;
    //@@{ 创建事件:createEvent, 鼠标事件_:MouseEvent }
    创建事件(事件接口: "鼠标事件_"): 鼠标事件_;
    //@@{ 创建事件:createEvent, 鼠标事件_:MouseEvent }
    创建事件(事件接口: "鼠标事件组_"): 鼠标事件_;
    //@@{ 创建事件:createEvent, 突变事件_:MutationEvent }
    创建事件(事件接口: "突变事件_"): 突变事件_;
    //@@{ 创建事件:createEvent, 突变事件_:MutationEvent }
    创建事件(事件接口: "突变事件组_"): 突变事件_;
    //@@{ 创建事件:createEvent, 导航完成事件_:NavigationCompletedEvent }
    创建事件(事件接口: "导航完成事件_"): 导航完成事件_;
    //@@{ 创建事件:createEvent, 导航事件_:NavigationEvent }
    创建事件(事件接口: "导航事件_"): 导航事件_;
    //@@{ 创建事件:createEvent, 导航事件与介绍人_:NavigationEventWithReferrer }
    创建事件(事件接口: "导航事件与介绍人_"): 导航事件与介绍人_;
    //@@{ 创建事件:createEvent, 离线音频完成事件_:OfflineAudioCompletionEvent }
    创建事件(事件接口: "离线音频完成事件_"): 离线音频完成事件_;
    //@@{ 创建事件:createEvent, 溢出事件_:OverflowEvent }
    创建事件(事件接口: "溢出事件_"): 溢出事件_;
    //@@{ 创建事件:createEvent, 页面过渡事件_:PageTransitionEvent }
    创建事件(事件接口: "页面过渡事件_"): 页面过渡事件_;
    //@@{ 创建事件:createEvent, 付款请求更新事件_:PaymentRequestUpdateEvent }
    创建事件(事件接口: "付款请求更新事件_"): 付款请求更新事件_;
    //@@{ 创建事件:createEvent, 许可请求事件_:PermissionRequestedEvent }
    创建事件(事件接口: "许可请求事件_"): 许可请求事件_;
    //@@{ 创建事件:createEvent, 指针事件_:PointerEvent }
    创建事件(事件接口: "指针事件_"): 指针事件_;
    //@@{ 创建事件:createEvent, 回退状态事件:PopStateEvent }
    创建事件(事件接口: "回退状态事件_"): 回退状态事件;
    //@@{ 创建事件:createEvent, 进度事件_:ProgressEvent }
    创建事件(事件接口: "进度事件_"): 进度事件_;
    //@@{ 创建事件:createEvent, RTCDTMF声调改变事件_:RTCDTMFToneChangeEvent }
    创建事件(事件接口: "RTCDTMF声调改变事件_"): RTCDTMF声调改变事件_;
    //@@{ 创建事件:createEvent, RTCDtls传输状态改变事件_:RTCDtlsTransportStateChangedEvent }
    创建事件(事件接口: "RTCDtls传输状态改变事件_"): RTCDtls传输状态改变事件_;
    //@@{ 创建事件:createEvent, RTCIce候选一对改变事件_:RTCIceCandidatePairChangedEvent }
    创建事件(事件接口: "RTCIce候选一对改变事件_"): RTCIce候选一对改变事件_;
    //@@{ 创建事件:createEvent, RTCIce采集者事件_:RTCIceGathererEvent }
    创建事件(事件接口: "RTCIce采集者事件_"): RTCIce采集者事件_;
    //@@{ 创建事件:createEvent, RTCIce传输状态改变事件_:RTCIceTransportStateChangedEvent }
    创建事件(事件接口: "RTCIce传输状态改变事件_"): RTCIce传输状态改变事件_;
    //@@{ 创建事件:createEvent, RTC对等连接Ice事件_:RTCPeerConnectionIceEvent }
    创建事件(事件接口: "RTC对等连接Ice事件_"): RTC对等连接Ice事件_; 
    //@@{ 创建事件:createEvent, RTCSsrc冲突事件_:RTCSsrcConflictEvent }
    创建事件(事件接口: "RTCSsrc冲突事件_"): RTCSsrc冲突事件_;
    //@@{ 创建事件:createEvent, SVG放缩事件_:SVGZoomEvent }
    创建事件(事件接口: "SVG放缩事件_"): SVG放缩事件_;
    //@@{ 创建事件:createEvent, SVG放缩事件_:SVGZoomEvent }
    创建事件(事件接口: "SVG放缩事件组_"): SVG放缩事件_;
    //@@{ 创建事件:createEvent, 脚本通知事件_:ScriptNotifyEvent }
    创建事件(事件接口: "脚本通知事件_"): 脚本通知事件_;
    //@@{ 创建事件:createEvent, 服务工人消息事件_:ServiceWorkerMessageEvent }
    创建事件(事件接口: "服务工人消息事件_"): 服务工人消息事件_;
    //@@{ 创建事件:createEvent, 语音合成事件_:SpeechSynthesisEvent }
    创建事件(事件接口: "语音合成事件_"): 语音合成事件_;
    //@@{ 创建事件:createEvent, 存储事件_:StorageEvent }
    创建事件(事件接口: "存储事件_"): 存储事件_;
    //@@{ 创建事件:createEvent, 文本事件_:TextEvent }
    创建事件(事件接口: "文本事件_"): 文本事件_;
    //@@{ 创建事件:createEvent, 触摸事件_:TouchEvent }
    创建事件(事件接口: "触摸事件_"): 触摸事件_;
    //@@{ 创建事件:createEvent, 轨道事件_:TrackEvent }
    创建事件(事件接口: "轨道事件_"): 轨道事件_;
    //@@{ 创建事件:createEvent, 过渡事件_:TransitionEvent }
    创建事件(事件接口: "过渡事件_"): 过渡事件_;
    //@@{ 创建事件:createEvent, UI事件_:UIEvent }
    创建事件(事件接口: "UI事件_"): UI事件_;
    //@@{ 创建事件:createEvent, UI事件_:UIEvent }
    创建事件(事件接口: "UI事件组_"): UI事件_;
    //@@{ 创建事件:createEvent, 无法观看内容识别事件_:UnviewableContentIdentifiedEvent }
    创建事件(事件接口: "无法观看内容识别事件_"): 无法观看内容识别事件_;
    //@@{ 创建事件:createEvent, WebGL上下文事件_:WebGLContextEvent }
    创建事件(事件接口: "WebGL上下文事件_"): WebGL上下文事件_;
    //@@{ 创建事件:createEvent, 轮事件_:WheelEvent }
    创建事件(事件接口: "轮事件_"): 轮事件_;
    //@@{ 创建事件:createEvent, 事件_:Event }
    创建事件(事件接口: 文字): 事件_;
...
接口 全局事件处理程序_ {
    ...
    //@@{ 添加事件监听器:addEventListener, 全局事件处理程序事件映射_:GlobalEventHandlersEventMap, 全局事件处理程序_:GlobalEventHandlers }
...
接口 MS基读者_ {
    ...
    //@@{ __加载中__:LOADING }
    只读 __加载中__: 数字;
    //@@{ 添加事件监听器:addEventListener, MS基读者事件映射_:MSBaseReaderEventMap, MS基读者_:MSBaseReader }
...
接口 MS导航器无轨道_ {
    //@@{ 确认站点特定跟踪异常:confirmSiteSpecificTrackingException, 确认站点特定的异常信息_:ConfirmSiteSpecificExceptionsInformation }
    确认站点特定跟踪异常(参数组: 确认站点特定的异常信息_): 真假;
    //@@{ 确认网络宽跟踪异常:confirmWebWideTrackingException, 异常信息_:ExceptionInformation }
    确认网络宽跟踪异常(参数组: 异常信息_): 真假;
    //@@{ 删除站点特定的跟踪异常:removeSiteSpecificTrackingException, 异常信息_:ExceptionInformation }
    删除站点特定的跟踪异常(参数组: 异常信息_): 无值;
    //@@{ 删除网络范围的跟踪异常:removeWebWideTrackingException, 异常信息_:ExceptionInformation }
    删除网络范围的跟踪异常(参数组: 异常信息_): 无值;
    //@@{ 存储站点特定的跟踪异常:storeSiteSpecificTrackingException, 存储站点具体的异常信息_:StoreSiteSpecificExceptionsInformation }
    存储站点特定的跟踪异常(参数组: 存储站点具体的异常信息_): 无值;
    //@@{ 存储网络宽跟踪异常:storeWebWideTrackingException, 存储异常信息_:StoreExceptionsInformation }
    存储网络宽跟踪异常(参数组: 存储异常信息_): 无值;

}
//@@{ 导航信标_:NavigatorBeacon }
接口 导航信标_ {
    //@@{ 发送信标:sendBeacon, USV字符串:USVString, 体初始化_:BodyInit }
...
接口 导航用户媒体_ {
    ...
    只读 媒体设备: 媒体设备_;
    //@@{ 取用户媒体:getUserMedia, 媒体流约束_:MediaStreamConstraints, 导航器用户媒体成功回调_:NavigatorUserMediaSuccessCallback, 导航器用户媒体错误回调_:NavigatorUserMediaErrorCallback }
    取用户媒体(约束: 媒体流约束_, 成功回调: 导航器用户媒体成功回调_, 错误回调: 导航器用户媒体错误回调_): 无值;

}
//@@{ 节点选择器_:NodeSelector }
接口 节点选择器_ {
    //@@{ 查询选择器:querySelector, 元素标签名称映射_:ElementTagNameMap }
    查询选择器<K 扩展 键为 元素标签名称映射_>(选择: K): 元素标签名称映射_[K] | 空值;
    //@@{ 查询选择器:querySelector, 元素_:Element }
    查询选择器<E 扩展 元素_ = 元素_>(选择: 文字): E | 空值;
    //@@{ 查询选择所有:querySelectorAll, 元素列表标签名称映射_:ElementListTagNameMap }
    查询选择所有<K 扩展 键为 元素列表标签名称映射_>(选择: K): 元素列表标签名称映射_[K];
    //@@{ 查询选择所有:querySelectorAll, 元素_:Element, 节点列表的_:NodeListOf }
    查询选择所有<E 扩展 元素_ = 元素_>(选择: 文字): 节点列表的_<E>;

}
//@@{ 随机源_:RandomSource }
接口 随机源_ {
    //@@{ 取随机值:getRandomValues, 整数数组8_:Int8Array, 正整数固定数组8_:Uint8ClampedArray, 正整数数组8_:Uint8Array, 整数数组16_:Int16Array, 正整数数组16_:Uint16Array, 整数数组32_:Int32Array, 正整数数组32_:Uint32Array }
...
接口 XMLHttp请求事件目标_ {
    ...
    //@@{ 添加事件监听器:addEventListener, XMLHttp请求事件目标事件映射_:XMLHttpRequestEventTargetEventMap, XMLHttp请求事件目标_:XMLHttpRequestEventTarget }
...
接口 广播频道_ 扩展 事件目标_ {
    ...
    //@@{ 发布消息:postMessage }
    发布消息(消息: 任意): 无值;
    //@@{ 添加事件监听器:addEventListener, 广播频道事件映射_:BroadcastChannelEventMap, 广播频道_:BroadcastChannel }
    添加事件监听器<K 扩展 键为 广播频道事件映射_>(类型: K, 侦听器: (本体: 广播频道_, ev: 广播频道事件映射_[K]) => 任意, 使用捕获?: 真假): 无值;
    //@@{ 添加事件监听器:addEventListener, 事件侦听器或事件侦听器对象_:EventListenerOrEventListenerObject }
    添加事件监听器(类型: 文字, 侦听器: 事件侦听器或事件侦听器对象_, 使用捕获?: 真假): 无值;

}
//@@{ 广播频道_:BroadcastChannel }
声明 值量 广播频道_: {
...
接口 位图图像选项_ {
    //@@{ 图像取向:imageOrientation }
    图像取向?: "没有" | "翻转Y";
    //@@{ 自左乘阿尔法:premultiplyAlpha }
    自左乘阿尔法?: "没有" | "自左乘" | "默认";
    //@@{ 颜色空间转换:colorSpaceConversion }
    颜色空间转换?: "没有" | "默认";
    //@@{ 调整宽度:resizeWidth }
    调整宽度?: 数字;
    //@@{ 调整高度:resizeHeight }
...
接口 HTML限位符元素_ 扩展 HTML元素_ {
    //@@{ 名字:name }
    名字: 文字;
    //@@{ 分配节点:assignedNodes, 分配节点选项_:AssignedNodesOptions, 节点_:Node }
    分配节点(选项?: 分配节点选项_): 节点_[];
...
接口 自定义元素注册表_ {
    //@@{ 定义:define, 函数_:Function, 元素定义选项_:ElementDefinitionOptions }
    定义(名字: 文字, 构造函数: 函数_, 选项?: 元素定义选项_): 无值;
    //@@{ 获取:get }
    获取(名字: 文字): 任意;
    //@@{ 当定义:whenDefined, 预设等_:PromiseLike }
    当定义(名字: 文字): 预设等_<无值>;
...
接口 报头_ {
     ...
     */
    //@@{ 可迭代迭代器_:IterableIterator, 条目:entries }
    条目(): 可迭代迭代器_<[文字, 文字]>;

    /**
     * Returns an iterator allowing to go through all keys f the key/value pairs contained in this object.
     */
    //@@{ 可迭代迭代器_:IterableIterator, 键组:keys }
    键组(): 可迭代迭代器_<文字>;

    /**
     * Returns an iterator allowing to go through all values of the key/value pairs contained in this object.
     */
    //@@{ 可迭代迭代器_:IterableIterator, 值组:values }
    值组(): 可迭代迭代器_<文字>;
...
接口 节点列表_ {
     ...
     */
    //@@{ 可迭代迭代器_:IterableIterator, 节点_:Node, 条目:entries  }
    条目(): 可迭代迭代器_<[数字, 节点_]>;
     ...
     */
    //@@{ 节点_:Node, 节点列表_:NodeList, 循环执行:forEach, 回调函数:callbackfn, 值:value, 索引:index, 列表Obj:listObj, 本体参数:thisArg }
    循环执行(回调函数: (值: 节点_, 索引: 数字, 列表Obj: 节点列表_) => 无值, 本体参数?: 任意): 无值;
     ...
     */
    //@@{ 可迭代迭代器_:IterableIterator, 节点_:Node, 值组:values }
    值组(): 可迭代迭代器_<节点_>;
    //@@{ 符号_:Symbol, 迭代器:iterator, 可迭代迭代器_:IterableIterator, 节点_:Node }
    [符号_.迭代器](): 可迭代迭代器_<节点_>;

}
//@@{ 节点列表的_:NodeListOf, T节点:TNode, 节点_:Node }
接口 节点列表的_<T节点 扩展 节点_> {

    /**
     * Returns an array of key, value pairs for every entry in the list
     */
    //@@{ 可迭代迭代器_:IterableIterator, T节点:TNode }
    条目(): 可迭代迭代器_<[数字, T节点]>;
     ...
     * @param 本体参数  An object to which the this keyword can refer in the callbackfn function. If thisArg is omitted, undefined is used as the this value.
     */
    //@@{ T节点:TNode, 节点列表的_:NodeListOf, 回调函数:callbackfn, 值:value, 索引:index, 列表Obj:listObj, 本体参数:thisArg }
    循环执行(回调函数: (值: T节点, 索引: 数字, 列表Obj: 节点列表的_<T节点>) => 无值, 本体参数?: 任意): 无值;
...
//@@{ HTML集合基_:HTMLCollectionBase }
接口 HTML集合基_ {
    //@@{ 符号_:Symbol, 迭代器:iterator, 可迭代迭代器_:IterableIterator, 元素_:Element }
    [符号_.迭代器](): 可迭代迭代器_<元素_>;

}
//@@{ HTML集合的_:HTMLCollectionOf, 元素_:Element }
接口 HTML集合的_<T 扩展 元素_> {
    //@@{ 符号_:Symbol, 迭代器:iterator, 可迭代迭代器_:IterableIterator }
    [符号_.迭代器](): 可迭代迭代器_<T>;
...
接口 表单数据_ {
     ...
     * Returns an array of key, value pairs for every entry in the list
     */
    //@@{ 可迭代迭代器_:IterableIterator, 文件_:File, 条目:entries }
    条目(): 可迭代迭代器_<[文字, 文字 | 文件_]>;
     ...
     */
    //@@{ 可迭代迭代器_:IterableIterator, 文件_:File, 值组:values }
    值组(): 可迭代迭代器_<文字 | 文件_>;
    //@@{ 符号_:Symbol, 迭代器:iterator, 可迭代迭代器_:IterableIterator, 文件_:File }
