...
declare namespace ts.server {
    ...
    function convertScriptKindName(scriptKindName: protocol.ScriptKindName): ScriptKind.Unknown | ScriptKind.JS | ScriptKind.JSX | ScriptKind.TS | ScriptKind.CTS | ScriptKind.TSX | ScriptKind.CTSX;
    /**
