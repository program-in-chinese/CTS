...
namespace ts.tscWatch {
    ...
    describe("tsc-watch program updates", () => {
        ...
        it("create configured project without file list", () => {
            ...
            checkWatchedDirectories(host, [configDir, combinePaths(configDir, projectSystem.nodeModulesAtTypesCh), combinePaths(configDir, projectSystem.nodeModulesAtTypes)], /*recursive*/ true);
        });
