...
namespace ts {
    ...
    function extensionIsOk(extensions: Extensions, extension: Extension): boolean {
        switch (extensions) {
            ...
            case Extensions.TypeScript:
                return extension === Extension.Ts || extension === Extension.CTs || extension === Extension.CTsx || extension === Extension.Tsx || extension === Extension.Dts || extension === Extension.DCts;
            case Extensions.DtsOnly:
