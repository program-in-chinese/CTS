...
namespace ts {
    ...
    function printHelp(showAllOptions: boolean) {
        ...
        syntax += "cts [" + getDiagnosticText(Diagnostics.options) + "] [" + getDiagnosticText(Diagnostics.file) + " ...]";
        ...
        output.push(getDiagnosticText(Diagnostics.Examples_Colon_0, makePadding(marginLength - examplesLength) + "cts hello.ts") + sys.newLine);
        output.push(padding + "cts --outFile file.js file.ts" + sys.newLine);
        output.push(padding + "cts @args.txt" + sys.newLine);
