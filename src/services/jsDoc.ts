...
namespace ts.JsDoc {
    const jsDocTagNames = [
        ...
        "typedef",
        "version",
        unicodeDic.JSDoc.augments,
        unicodeDic.JSDoc.extends,
        unicodeDic.JSDoc.class,
        unicodeDic.JSDoc.prop,
        unicodeDic.JSDoc.property,
        unicodeDic.JSDoc.constructor,
        unicodeDic.JSDoc.arg,
        unicodeDic.JSDoc.argument,
        unicodeDic.JSDoc.param,
        unicodeDic.JSDoc.return,
        unicodeDic.JSDoc.returns,
        unicodeDic.JSDoc.template,
        unicodeDic.JSDoc.type,
        unicodeDic.JSDoc.typedef
    ];
