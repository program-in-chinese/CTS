...
const zhcnes2015LibrarySources = [
    "es2015.core.d.cts",
    "es2015.collection.d.cts",
    "es2015.generator.d.cts",
    "es2015.iterable.d.cts",
    "es2015.promise.d.cts",
    "es2015.proxy.d.cts",
    "es2015.reflect.d.cts",
    "es2015.symbol.d.cts",
    "es2015.symbol.wellknown.d.cts"
];

const es2015LibrarySourceMap = es2015LibrarySources.map(source =>
    ({ target: "lib." + source, sources: ["header.d.ts", source] }));
const zhcnes2015LibrarySourceMap = zhcnes2015LibrarySources.map(source =>
    ({ target: "lib.zh-cn." + source, sources: ["header.d.cts", source] }));


const es2016LibrarySource = ["es2016.array.include.d.ts"];
const zhcnes2016LibrarySource = ["es2016.array.include.d.cts"];

const es2016LibrarySourceMap = es2016LibrarySource.map(source =>
    ({ target: "lib." + source, sources: ["header.d.ts", source] }));
const zhcnes2016LibrarySourceMap = zhcnes2016LibrarySource.map(source =>
        ({ target: "lib.zh-cn." + source, sources: ["header.d.cts", source] }));
...
const zhcnes2017LibrarySource = [
    "es2017.object.d.cts",
    "es2017.sharedmemory.d.cts",
    "es2017.string.d.cts",
    "es2017.intl.d.cts",
    "es2017.typedarrays.d.cts",
];

const es2017LibrarySourceMap = es2017LibrarySource.map(source =>
    ({ target: "lib." + source, sources: ["header.d.ts", source] }));
const zhcnes2017LibrarySourceMap = zhcnes2017LibrarySource.map(source =>
        ({ target: "lib.zh-cn." + source, sources: ["header.d.cts", source] }));
...
const zhcnes2018LibrarySource = [
    "es2018.regexp.d.cts",
    "es2018.promise.d.cts"
];

const es2018LibrarySourceMap = es2018LibrarySource.map(source =>
    ({ target: "lib." + source, sources: ["header.d.ts", source] }));
const zhcnes2018LibrarySourceMap = zhcnes2018LibrarySource.map(source =>
    ({ target: "lib.zh-cn." + source, sources: ["header.d.cts", source] }));
...
const zhcnesnextLibrarySource = [
    "esnext.asynciterable.d.cts",
    "esnext.array.d.cts"
];
...
const zhcnesnextLibrarySourceMap = zhcnesnextLibrarySource.map(source =>
    ({ target: "lib.zh-cn." + source, sources: ["header.d.cts", source] }));

const hostsLibrarySources = ["dom.generated.d.ts", "webworker.importscripts.d.ts", "scripthost.d.ts"];
const zhcnhostsLibrarySources = ["dom.generated.d.cts", "webworker.importscripts.d.cts", "scripthost.d.cts"];
...
const zhcnlibrarySourceMap = [
    ...
    { target: "lib.zh-cn.es2015.d.cts", sources: ["header.d.cts", "es2015.d.cts"] },
    { target: "lib.zh-cn.es2016.d.cts", sources: ["header.d.cts", "es2016.d.cts"] },
    { target: "lib.zh-cn.es2017.d.cts", sources: ["header.d.cts", "es2017.d.cts"] },
    { target: "lib.zh-cn.es2018.d.cts", sources: ["header.d.cts", "es2018.d.cts"] },
    { target: "lib.zh-cn.esnext.d.cts", sources: ["header.d.cts", "esnext.d.cts"] },

    // JavaScript + all host library
    { target: "lib.zh-cn.d.cts", sources: ["header.d.cts", "es5.d.cts"].concat(zhcnhostsLibrarySources) },
    { target: "lib.zh-cn.es6.d.cts", sources: ["header.d.cts", "es5.d.cts"].concat(zhcnes2015LibrarySources, zhcnhostsLibrarySources, "dom.iterable.d.cts") },
    { target: "lib.zh-cn.es2016.full.d.cts", sources: ["header.d.cts", "es2016.d.cts"].concat(zhcnhostsLibrarySources, "dom.iterable.d.cts") },
    { target: "lib.zh-cn.es2017.full.d.cts", sources: ["header.d.cts", "es2017.d.cts"].concat(zhcnhostsLibrarySources, "dom.iterable.d.cts") },
    { target: "lib.zh-cn.es2018.full.d.cts", sources: ["header.d.cts", "es2018.d.cts"].concat(zhcnhostsLibrarySources, "dom.iterable.d.cts") },
    { target: "lib.zh-cn.esnext.full.d.cts", sources: ["header.d.cts", "esnext.d.cts"].concat(zhcnhostsLibrarySources, "dom.iterable.d.cts") },
].concat(zhcnes2015LibrarySourceMap, zhcnes2016LibrarySourceMap, zhcnes2017LibrarySourceMap, zhcnes2018LibrarySourceMap, zhcnesnextLibrarySourceMap);

const libraryTargets = librarySourceMap.map(f =>
    path.join(builtLocalDirectory, f.target));
const zhcnlibraryTargets = zhcnlibrarySourceMap.map(f =>
    path.join(builtLocalDirectory, f.target));
...
for (const i in zhcnlibraryTargets) {
    const entry = zhcnlibrarySourceMap[i];
    const target = zhcnlibraryTargets[i];
    const sources = [copyright].concat(entry.sources.map(s => path.join(libraryDirectory, s)));
    gulp.task(target, /*help*/ false, [], () =>
        gulp.src(sources)
            .pipe(newer(target))
...
function getCompilerSettings(base, useBuiltCompiler) {
    ...
    if (useBuiltCompiler === true) {
        copy.typescript = /** @type {*} */ (require("./built/local/ctsscript.js"));
    }
...
gulp.task("libzhcn", "Builds the library zhcntargets", zhcnlibraryTargets);
...
gulp.task(servicesFile, /*help*/ false, ["lib","libzhcn", "generate-diagnostics"], () => {
...
gulp.task(typingsInstallerJs, /*help*/ false, [servicesFile], () => {
    ...
    return cancellationTokenProject.src()
        ...
        .pipe(prependCopyright())
        .pipe(sourcemaps.write("."))
        .pipe(gulp.dest("src/server/typingsunInstaller"));
});
...
const tsserverLibraryFile = path.join(builtLocalDirectory, "ctslibrary.js");
const tsserverLibraryDefinitionFile = path.join(builtLocalDirectory, "ctslibrary.d.ts");
...
gulp.task("VerifyLKG", /*help*/ false, [], () => {
    const expectedFiles = [builtLocalCompiler, servicesFile, serverFile, nodePackageFile, nodeDefinitionsFile, standaloneDefinitionsFile, tsserverLibraryFile, tsserverLibraryDefinitionFile, typingsInstallerJs, cancellationTokenJs].concat(libraryTargets,zhcnlibraryTargets);
...
gulp.task("LKGInternal", /*help*/ false, ["lib","libzhcn", "local"]);
